const LoginScreen = ({ email, setEmail, onSubmit, loading }) => {
    return <>
        <div className='mb-8'>
            <h4 className="text-3xl font-bold mb-2 text-center">Iniciar sesión</h4>
            <p className='text-center w-full text-gray-600'>Te enviaremos un código de acceso a tu correo.</p>
        </div>
        <form onSubmit={onSubmit} className="text-start mb-6">
            <div className="mb-6">
        ...
        <p className="text-sm text-center">¿No tienes cuenta?
            <a href="/register" className="text-primary ml-1 underline">Crea una en segundos</a>
        </p>
    </>
}
