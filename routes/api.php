...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->middleware('admin.permission')->group(function () {
        ...
        Route::prefix('magistrales')->group(function () {
            $magistralesAny = 'module.permission:magistrales-dashboard,magistrales-products,magistrales-procurement,magistrales-warehouse,magistrales-billing,magistrales-articles,magistrales-category,magistrales-formats,magistrales-formulas,magistrales-inventory,magistrales-kardex,magistrales-laboratory,magistrales-production-order,magistrales-supplier,magistrales-responsible,magistrales-unit,magistrales-sales';
        ...
        Route::prefix('storage')->group(function () {
            ...
            Route::middleware('module.permission:storage-billing-control')->group(function () {
                ...
                Route::post('/billing-control/{id}/receivable-payment', [AdminStorageBillingControlController::class, 'registerReceivablePayment']);
        ...
        Route::post('/sales-channels', [AdminSalesChannelController::class, 'save']);
        Route::post('/sales-channels/paginate', [AdminSalesChannelController::class, 'paginate']);
        Route::patch('/sales-channels/status', [AdminSalesChannelController::class, 'status']);
        Route::patch('/sales-channels/{field}', [AdminSalesChannelController::class, 'boolean']);
        Route::delete('/sales-channels/{id}', [AdminSalesChannelController::class, 'delete']);

        Route::post('/sales-subchannels', [AdminSalesSubchannelController::class, 'save']);
        Route::post('/sales-subchannels/paginate', [AdminSalesSubchannelController::class, 'paginate']);
        ...
        Route::get('/referral-guides/warehouse-articles', [AdminReferralGuideController::class, 'warehouseArticles']);
        ...
        Route::post('/billing-documents/{id}/receivable-payment', [AdminBillingDocumentController::class, 'registerReceivablePayment']);
