var za=Object.defineProperty;var Va=(e,n,i)=>n in e?za(e,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[n]=i;var Qn=(e,n,i)=>Va(e,typeof n!="symbol"?n+"":n,i);import{C as Wa,c as qa,j as r,r as d,S as z,G as Ya}from"./CreateReactScript-DN_jDYSK.js";import{L as Ha,G as Ka,M as Ja}from"./esm-Dqpi5RN1.js";import{B as Xa}from"./Base-C_ABSQmx.js";import{T as an,t as Zn,k as er,l as Fr,m as tr}from"./Table-CP5fak-a.js";import{M as st}from"./Modal-GG8PqYQn.js";import{R as Qa}from"./ReactAppend-DFJLDjUw.js";import{a as Be,S as Ge}from"./SetSelectValue-DMC-VMbd.js";import{S as Za}from"./SelectFormGroup-JcFrWqgO.js";import{T as nr}from"./TextareaFormGroup-D-A0_uuo.js";import{B as ei}from"./BillingDocumentsRest-lY4zjKLK.js";import{C as Er}from"./CommercialOrdersRest-CYdjmpuI.js";import{B as ti}from"./BasicRest-BAw20ucR.js";import{R as ni}from"./ReferralGuidesRest-B78MnvHq.js";import{o as Ft,b as Et}from"./magistralesRecordPdf-BCuy7mhu.js";import"./tippy-react.esm-YgLf3Pdz.js";import"./permissionScope-Be8AULz2.js";import"./ubigeoInei-D0FnAslC.js";class ri extends ti{constructor(){super(...arguments);Qn(this,"path","admin/delivery-delay-reasons")}}const rr="billing-voucher-preview-modal",dn="billing-voucher-preview-frame";let ve=null;const v=(e,n,i="")=>n.split(".").reduce((o,m)=>o==null?void 0:o[m],e)??i,ue=(e,n="-")=>e==null||e===""?n:`${e}`,un=e=>{if(!e)return"-";const n=`${e}`;return n.includes("T"),n.slice(0,10)},ze=(e,n=2)=>Number(e||0).toFixed(n),Sr=(e="PEN")=>{const n=`${e??"PEN"}`.toUpperCase();return n==="USD"?"US$":n==="EUR"?"EUR":"S/."},ai=(e,n="PEN")=>`${Sr(n)} ${ze(e)}`,$r=e=>[e==null?void 0:e.series,e==null?void 0:e.sequence].filter(Boolean).join("-")||(e==null?void 0:e.code)||"-",Tr=e=>{const n=`${e??""}`.trim().toLowerCase();return n.includes("boleta")?`BOLETA DE VENTA
