var Ja=Object.defineProperty;var Xa=(e,n,i)=>n in e?Ja(e,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[n]=i;var tr=(e,n,i)=>Xa(e,typeof n!="symbol"?n+"":n,i);import{C as Qa,c as Za,j as r,r as d,S as A,G as ei}from"./CreateReactScript-CdmfSZFN.js";import{L as ti,G as ni,M as ri}from"./esm-u0gzBv0B.js";import{B as ai}from"./Base-DE0xkm2l.js";import{T as ln,t as nr,k as rr,l as Er,m as ar}from"./Table-B71hRSDz.js";import{M as Ge}from"./Modal-hhrZ7Bim.js";import{R as ii}from"./ReactAppend-BtQv1fRi.js";import{a as Ue,S as $e}from"./SetSelectValue-BAr-PCgT.js";import{S as si}from"./SelectFormGroup-gIFjD1TR.js";import{T as on}from"./TextareaFormGroup-DRoDaCp-.js";import{B as li}from"./BillingDocumentsRest-BTK95jM8.js";import{C as Dr}from"./CommercialOrdersRest-DqjH5zUB.js";import{B as oi}from"./BasicRest-CZzcCcH0.js";import{R as ci}from"./ReferralGuidesRest-COrSqgSo.js";import{o as Dt,b as kt}from"./magistralesRecordPdf-XCi0VvlK.js";import"./tippy-react.esm-BaOEM-MO.js";import"./permissionScope-Be8AULz2.js";import"./ubigeoInei-D0FnAslC.js";class di extends oi{constructor(){super(...arguments);tr(this,"path","admin/delivery-delay-reasons")}}const ir="billing-voucher-preview-modal",mn="billing-voucher-preview-frame";let ge=null;const _=(e,n,i="")=>n.split(".").reduce((o,h)=>o==null?void 0:o[h],e)??i,oe=(e,n="-")=>e==null||e===""?n:`${e}`,pn=e=>{if(!e)return"-";const n=`${e}`;return n.includes("T"),n.slice(0,10)},qe=(e,n=2)=>Number(e||0).toFixed(n),kr=(e="PEN")=>{const n=`${e??"PEN"}`.toUpperCase();return n==="USD"?"US$":n==="EUR"?"EUR":"S/."},ui=(e,n="PEN")=>`${kr(n)} ${qe(e)}`,Tr=e=>[e==null?void 0:e.series,e==null?void 0:e.sequence].filter(Boolean).join("-")||(e==null?void 0:e.code)||"-",Ir=e=>{const n=`${e??""}`.trim().toLowerCase();return n.includes("boleta")?`BOLETA DE VENTA
