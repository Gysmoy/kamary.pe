var Ja=Object.defineProperty;var Xa=(e,n,i)=>n in e?Ja(e,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[n]=i;var tr=(e,n,i)=>Xa(e,typeof n!="symbol"?n+"":n,i);import{C as Qa,c as Za,j as r,r as d,S as A,G as ei}from"./CreateReactScript-Di1kuK03.js";import{L as ti,G as ni,M as ri}from"./esm-DKHzvBm5.js";import{B as ai}from"./Base-B29zOyeK.js";import{T as ln,t as nr,k as rr,l as Er,m as ar}from"./Table-B1pz7BSu.js";import{M as Ge}from"./Modal-Zx87HGSA.js";import{R as ii}from"./ReactAppend-DoFYb-Jc.js";import{a as Ue,S as $e}from"./SetSelectValue-B9OmXXX0.js";import{S as si}from"./SelectFormGroup-DupmuxD3.js";import{T as on}from"./TextareaFormGroup-iJHqgfLU.js";import{B as li}from"./BillingDocumentsRest-Du4vglPZ.js";import{C as Dr}from"./CommercialOrdersRest-Vj0uVLPr.js";import{B as oi}from"./BasicRest-BX743yrP.js";import{R as ci}from"./ReferralGuidesRest-CUa_dk-T.js";import{o as Dt,b as kt}from"./magistralesRecordPdf-DaonkfWM.js";import"./tippy-react.esm-Dl7v7VoT.js";import"./permissionScope-DOiR_Kst.js";import"./ubigeoInei-D0FnAslC.js";class di extends oi{constructor(){super(...arguments);tr(this,"path","admin/delivery-delay-reasons")}}const ir="billing-voucher-preview-modal",mn="billing-voucher-preview-frame";let ge=null;const _=(e,n,i="")=>n.split(".").reduce((o,h)=>o==null?void 0:o[h],e)??i,oe=(e,n="-")=>e==null||e===""?n:`${e}`,pn=e=>{if(!e)return"-";const n=`${e}`;return n.includes("T"),n.slice(0,10)},qe=(e,n=2)=>Number(e||0).toFixed(n),kr=(e="PEN")=>{const n=`${e??"PEN"}`.toUpperCase();return n==="USD"?"US$":n==="EUR"?"EUR":"S/."},ui=(e,n="PEN")=>`${kr(n)} ${qe(e)}`,Tr=e=>[e==null?void 0:e.series,e==null?void 0:e.sequence].filter(Boolean).join("-")||(e==null?void 0:e.code)||"-",Ir=e=>{const n=`${e??""}`.trim().toLowerCase();return n.includes("boleta")?`BOLETA DE VENTA
