import{C as Pr,c as Or,j as t,r as s,S as Nt,G as Mr}from"./CreateReactScript-BQEmHc8B.js";import{L as Br,G as Lr,M as Gr}from"./esm-XAA1TWCO.js";import{B as qr}from"./Base-BZJCfbcl.js";import{T as zr}from"./Table-BwS8S_mo.js";import{M as wt}from"./Modal-BpHRFSoz.js";import{R as Rt}from"./ReactAppend-CmCssPze.js";import{S as Ur}from"./SwitchFormGroup-BFsLqEe8.js";import{a as Re,S as ke}from"./SetSelectValue-CKeZntsZ.js";import{S as Wr}from"./SelectFormGroup-BeLjaap0.js";import{T as Qt}from"./TextareaFormGroup-COu0G6AX.js";import{C as Vr}from"./CommercialOrdersRest-C3qyJH3l.js";import{R as Hr}from"./ReferralGuidesRest-CIzM-URQ.js";import{r as Kr}from"./renderGridEditLink-D8NGEeKJ.js";import{o as rt,b as nt}from"./magistralesRecordPdf-BahM45BG.js";import{t as it,i as Qr,j as Xr,k as Yr,p as Jr,l as sr,m as Zr,n as en,o as tn,g as rn}from"./statusLabels-BJ32pkWe.js";import"./BasicRest-BJmaHB2C.js";import"./tippy-react.esm-255dCUw_.js";import"./ubigeoInei-D0FnAslC.js";const O=new Vr,Xt=new Hr,nn=["client_kind","=","regular"],cn=[1,2,3,4,5],sn=["EFECTIVO [CONTADO]","TRANSFERENCIA [CONTADO]","YAPE [CONTADO]","PLIN [CONTADO]","TARJETA [CONTADO]","TRANSFERENCIA [CREDITO]"],fe=(r,{variant:i,title:m,icon:d,onClick:p})=>{const w=$('<button type="button"></button>').addClass(`btn btn-xs btn-soft-${i} commercial-order-action-btn`).attr("title",m).attr("aria-label",m).append($("<i></i>").addClass(d)).on("click",u=>{u.preventDefault(),u.stopPropagation(),p()});r.append(w)},on=r=>`commercial-order-status-badge commercial-order-status-${`${r??"empty"}`.trim().toLowerCase().replace(/[^a-z0-9_-]+/g,"-")||"empty"}`,ze=(r,i,m)=>{r.addClass("commercial-order-status-cell"),Rt(r,t.jsx("span",{className:on(i),children:m(i)}))},Ue=()=>({uid:crypto.randomUUID(),article_id:"",article_label:"",article_code:"",article_lot:"",article_name:"",article_unit:"",article_laboratory:"",article_principle:"",presentations:[],presentation_id:"",presentation_units:1,stock_available:0,reserved_quantity:0,price_unit:0,quantity:1,gross_total:0,discount_type:"none",discount_value:0,discount_amount:0,total:0,price_source:"fallback",price_list_code:""}),Ct=r=>{if(!r)return"";const i=(r.name??"").toString().trim().split(" ")[0]??"",m=(r.lastname??"").toString().trim().split(" ")[0]??"",d=`${i} ${m}`.trim(),p=(r.username??"").toString().trim();return d&&p?`${d} (@${p})`:d||(p?`@${p}`:"")},We=r=>Number(Number(r||0).toFixed(2)),an=r=>$("<div>").text(r??"").html(),Se=r=>{const i=Number(Number(r||0).toFixed(3));return Number.isInteger(i)?`${i}`:`${i}`.replace(/\.?0+$/,"")},St=r=>(r==null?void 0:r.price_source)==="manual",Yt=(r,i,m=!1)=>{const d=Number((r==null?void 0:r.price_unit)||0),p=Number(i==null?void 0:i.price_unit);return!m&&St(r)||!Number.isFinite(p)||!m&&p<=0&&d>0?d:p},Jt=(r,i,m=!1)=>!m&&St(r)?"manual":(i==null?void 0:i.source)||(r==null?void 0:r.price_source)||"fallback",ln=r=>{const i=`${r??""}`.replace(",",".").replace(/[^\d.]/g,"");if(!i)return"";const[m,...d]=i.split("."),p=m.replace(/^0+(?=\d)/,"")||(m||d.length?"0":""),w=d.length?`.${d.join("")}`:"";return`${p}${w}`},Zt=r=>{const i=ln(r.target.value);return r.target.value!==i&&(r.target.value=i),Number(i||0)},er=r=>{Number(r.target.value||0)===0&&r.target.select()},dn=(r,i,m)=>{const d=We(r),p=Number(m||0);return!Number.isFinite(p)||p<=0||d<=0?0:i==="percent"?Math.min(d,We(d*Math.min(p,100)/100)):i==="amount"?Math.min(d,We(p)):0},be=r=>{const i=Number(r.quantity||0),m=Number(r.price_unit||0),d=Number.isFinite(i*m)?We(i*m):0,p=dn(d,r.discount_type,r.discount_value);return{...r,discount_type:r.discount_type||"none",discount_value:r.discount_type==="none"?0:Number(r.discount_value||0),gross_total:d,discount_amount:p,total:We(Math.max(0,d-p))}},st=r=>{const i=`${r??""}`.trim().toLowerCase();return i==="boleta"?"Boleta":["nota de pedido","nota_pedido","note_order"].includes(i)?"Nota de pedido":"Factura"},C=(r,i="")=>{if(r==null)return i;if(typeof r=="object")return r.address??r.reference??r.name??r.description??i;const m=`${r}`;return m==="[object Object]"?i:m},un=r=>`${r??""}`.toUpperCase().includes("CREDITO")?"Credito":"Contado",mn=r=>{const i=`${r??""}`.trim();return i?i.toUpperCase()==="TRANSFERENCIA"?"TRANSFERENCIA [CONTADO]":i:"EFECTIVO [CONTADO]"},pn=r=>C(r==null?void 0:r.full_address,C(r==null?void 0:r.address,C(r==null?void 0:r.fiscal_address))),fn=r=>C(r==null?void 0:r.ubigeo,C(r==null?void 0:r.district_ubigeo,C(r==null?void 0:r.inei_ubigeo))),tr=r=>{const i=`${r??""}`.trim(),m=i.match(/^(client|eventual)-(\d+)$/);return m?m[2]:i},rr=r=>{var u,h,S;if(r.loading)return r.text;const i=r.data??{},m=r.text||i.name||"",d=(u=i.branch)==null?void 0:u.name,p=(S=(h=i.branch)==null?void 0:h.business)==null?void 0:S.name,w=$("<span>").text(m);return d&&w.append($("<small>").addClass("text-muted ms-1").text(`- ${d}`)),p&&w.append($("<small>").addClass("text-muted ms-1").text(`(${p})`)),w},J=r=>{if(!(r!=null&&r.current))return;const i=$(r.current);i.empty().val(null),i.trigger(i.data("select2")?"change.select2":"change")},bn=r=>r.article_id?"Unidad base":"Sin presentacion",hn=(r,i)=>{const m=(r==null?void 0:r.name)||"Presentacion",d=Se((r==null?void 0:r.units)||1),p=i!=null&&i.article_unit?` ${i.article_unit}`:" unidad(es) base";return`${m} (${d}${p})`},_n=r=>["Factura","Boleta"].includes(st(r)),nr=(r,i)=>{const m=Number(r||0);if(!_n(i))return{subtotal:Number(m.toFixed(2)),taxAmount:0,total:Number(m.toFixed(2))};const d=Number((m/1.18).toFixed(2));return{subtotal:d,taxAmount:Number((m-d).toFixed(2)),total:Number(m.toFixed(2))}},gn=(r,i="")=>{const m=new Map;return(r??[]).flatMap(d=>{if(!(d!=null&&d.article_id))return[];const p=`${d.article_id}:${d.warehouse_id||i||""}`,w=Number(d.quantity||0),u=Number(d.presentation_units||1)||1,h=Number((w*u).toFixed(3)),S=Number(d.stock_available||0),I=Number(m.get(p)||0),P=Math.max(0,S-I),E=Math.min(h,P),M=Math.max(0,h-E);return m.set(p,I+E),M<=1e-4?[]:[{article:d.article_name||d.article_label||d.article_code||"Articulo",quantity:h,lineQuantity:w,presentationUnits:u,available:P,shortage:M}]})},ot=r=>(r==null?void 0:r.referral_guides)??(r==null?void 0:r.referralGuides)??[],kt=r=>(r==null?void 0:r.external_reference)||[r==null?void 0:r.series,r==null?void 0:r.sequence].filter(Boolean).join("-")||(r==null?void 0:r.code)||"-",xn=r=>r&&!["accepted","cancelled"].includes(r.guide_status),vn=r=>(r==null?void 0:r.delivery_evidences)??(r==null?void 0:r.deliveryEvidences)??[],$t=r=>vn(r)[0]??null,yn=r=>(r==null?void 0:r.tracking_events)??(r==null?void 0:r.trackingEvents)??[],ir=r=>{const i=`${r??""}`.trim();return i.startsWith("blob:")||i.startsWith("data:image/")||/\.(png|jpe?g|webp|gif|bmp|svg)(\?.*)?$/i.test(i)||i.includes("/delivery-evidence-media/")},cr=()=>{const r=new Date;return r.setMinutes(r.getMinutes()-r.getTimezoneOffset()),r.toISOString().slice(0,16)},ct={lat:-12.046374,lng:-77.042793},Z=r=>{const i=Number(r);return Number.isFinite(i)?i:null},at=r=>{const i=Z(r);return i===null?"":i.toFixed(7)},ee=r=>Z(r==null?void 0:r.lat)!==null&&Z(r==null?void 0:r.lng)!==null,jn=({modalRef:r,position:i,searchText:m,onPositionChange:d,onSearchTextChange:p,onAddressSelected:w,googleMapsApiKey:u})=>{const h=s.useRef(),[S,I]=s.useState(!1),[P,E]=s.useState(""),[M,q]=s.useState([]),z=ee(i)?{lat:Z(i.lat),lng:Z(i.lng)}:ct,T=(f,R=17)=>{const U=Z(f==null?void 0:f.lat),L=Z(f==null?void 0:f.lng);U===null||L===null||!h.current||(h.current.setCenter({lat:U,lng:L}),h.current.setZoom(R))},de=f=>{d(f),T(f)};s.useEffect(()=>{if(ee(i)){T(z);return}T(ct,13)},[i==null?void 0:i.lat,i==null?void 0:i.lng]),s.useEffect(()=>{const f=r==null?void 0:r.current;if(!f)return;const R=()=>{setTimeout(()=>{ee(i)?T(z):T(ct,13)},180)};return $(f).on("shown.bs.modal",R),()=>$(f).off("shown.bs.modal",R)},[r,i==null?void 0:i.lat,i==null?void 0:i.lng]);const B=async()=>{var R,U;const f=`${m??""}`.trim();if(!f){q([]),E("Escribe una direccion para buscar.");return}if(!((U=(R=window.google)==null?void 0:R.maps)!=null&&U.Geocoder)){E("Google Maps aun no termino de cargar.");return}I(!0),E("");try{new window.google.maps.Geocoder().geocode({address:`${f}, Peru`,componentRestrictions:{country:"PE"},region:"PE"},(te,_e)=>{if(I(!1),_e!=="OK"||!Array.isArray(te)||te.length===0){q([]),E("Sin resultados. Puedes marcar el punto manualmente en el mapa.");return}q(te.slice(0,5).map(X=>({place_id:X.place_id,display_name:X.formatted_address,lat:X.geometry.location.lat(),lng:X.geometry.location.lng()})))})}catch(L){I(!1),E(`${L.message}. Puedes marcar el punto manualmente en el mapa.`),q([])}},he=f=>{const R={lat:Z(f.lat),lng:Z(f.lng)};d(R),p(f.display_name??""),w(f.display_name??""),T(R),q([])};return t.jsxs("div",{className:"commercial-order-map-picker",children:[t.jsxs("div",{className:"commercial-order-map-search",children:[t.jsxs("div",{children:[t.jsx("label",{className:"form-label",children:"Buscar direccion en mapa"}),t.jsxs("div",{className:"input-group",children:[t.jsx("input",{type:"text",className:"form-control",value:m,onChange:f=>p(f.target.value),onKeyDown:f=>{f.key==="Enter"&&(f.preventDefault(),B())},placeholder:"Ej. Av. Javier Prado 123, San Isidro"}),t.jsx("button",{type:"button",className:"btn btn-outline-primary",onClick:B,disabled:S,children:S?"Buscando...":"Buscar"})]})]}),t.jsxs("div",{className:"commercial-order-map-coordinates",children:[t.jsx("label",{className:"form-label",children:"Coordenadas"}),t.jsxs("div",{className:"commercial-order-map-coordinate-values",children:[t.jsx("span",{children:at(i==null?void 0:i.lat)||"-"}),t.jsx("span",{children:at(i==null?void 0:i.lng)||"-"})]})]})]}),M.length>0&&t.jsx("div",{className:"commercial-order-map-results",children:M.map(f=>t.jsx("button",{type:"button",className:"commercial-order-map-result",onClick:()=>he(f),children:f.display_name},`${f.place_id}-${f.lat}-${f.lng}`))}),P&&t.jsx("small",{className:"text-muted d-block mt-1",children:P}),t.jsx(Br,{googleMapsApiKey:u,language:"es",region:"PE",onError:()=>E("No se pudo cargar Google Maps. Revisa la API key y las restricciones de dominio."),children:t.jsx(Lr,{mapContainerClassName:"commercial-order-map-canvas",center:z,zoom:ee(i)?17:13,options:{clickableIcons:!0,fullscreenControl:!0,gestureHandling:"greedy",mapTypeControl:!0,scrollwheel:!0,streetViewControl:!1},onLoad:f=>{h.current=f,setTimeout(()=>{ee(i)?T(z):T(ct,13)},120)},onClick:f=>{const R={lat:f.latLng.lat(),lng:f.latLng.lng()};de(R)},children:ee(i)&&t.jsx(Gr,{position:z,draggable:!0,onDragEnd:f=>de({lat:f.latLng.lat(),lng:f.latLng.lng()})})})}),t.jsx("small",{className:"text-muted d-block mt-2",children:"Haz clic en el mapa o arrastra el marcador para fijar la ubicacion de entrega."})]})},Nn=r=>{const i=`${Mr.GMAPS_API_KEY??""}`.trim();return i?t.jsx(jn,{...r,googleMapsApiKey:i}):t.jsx("div",{className:"commercial-order-map-picker",children:t.jsx("div",{className:"commercial-order-map-empty",children:"Configura Google Maps API Key en Sistemas > Datos generales > Integraciones para habilitar el mapa."})})},wn=r=>!r||r.status===null||`${r.order_status??""}`=="cancelled"?!1:`${r.dispatch_status??"pending"}`=="pending",Cn=r=>{if(!r)return[];const i=yn(r).map(u=>({date:u.happened_at??u.created_at,status:[u.title,u.description].filter(Boolean).join(" - ")})),m=[{date:r.created_at,status:"La orden ingreso en el sistema"}];r.approved_at&&["preparing","in_route","delivered","dispatched","billed","closed"].includes(r.order_status)?m.push({date:r.approved_at,status:"La orden paso a preparacion"}):r.approved_at&&r.order_status==="confirmed"?m.push({date:r.approved_at,status:"La orden fue confirmada"}):["preparing","in_route","delivered","dispatched","billed","closed"].includes(r.order_status)&&m.push({date:r.updated_at,status:"La orden paso a preparacion"});const d=(r.dispatch_assignments??r.dispatchAssignments??[]).filter(u=>(u==null?void 0:u.status)!==!1&&(u==null?void 0:u.status)!==0&&(u==null?void 0:u.dispatch)).sort((u,h)=>{var S,I,P,E;return new Date(((S=u==null?void 0:u.dispatch)==null?void 0:S.departed_at)||((I=u==null?void 0:u.dispatch)==null?void 0:I.scheduled_date)||0)-new Date(((P=h==null?void 0:h.dispatch)==null?void 0:P.departed_at)||((E=h==null?void 0:h.dispatch)==null?void 0:E.scheduled_date)||0)}),p=d.find(u=>{var h;return["in_route","delivered","closed"].includes((h=u==null?void 0:u.dispatch)==null?void 0:h.dispatch_status)});p?(m.push({date:p.dispatch.departed_at??p.dispatch.updated_at??p.dispatch.created_at,status:`Manifiesto ${p.dispatch.manifest_code||p.dispatch.code||""}`.trim()}),m.push({date:p.dispatch.departed_at??p.dispatch.updated_at??p.dispatch.created_at,status:"El pedido salio en ruta"})):r.dispatch_status==="in_route"&&m.push({date:r.updated_at,status:"El pedido salio en ruta"}),(r.dispatch_status==="dispatched"||d.some(u=>{var h;return((h=u==null?void 0:u.dispatch)==null?void 0:h.dispatch_status)==="dispatched"}))&&m.push({date:r.updated_at,status:"El pedido paso a despacho"}),ot(r).forEach(u=>{m.push({date:u.issue_date??u.created_at??r.updated_at,status:`Guia de remision ${kt(u)} - ${sr(u.guide_status)}`})});const w=d.find(u=>{var h;return["delivered","closed"].includes((h=u==null?void 0:u.dispatch)==null?void 0:h.dispatch_status)});return w?m.push({date:w.dispatch.delivered_at??w.dispatch.updated_at??w.dispatch.created_at,status:"El pedido fue entregado"}):r.dispatch_status==="delivered"&&m.push({date:r.updated_at,status:"El pedido fue entregado"}),(r.order_status==="cancelled"||r.dispatch_status==="cancelled")&&m.push({date:r.updated_at,status:"El pedido fue cancelado"}),[...i,...m].filter(u=>u.date).sort((u,h)=>new Date(u.date)-new Date(h.date))},$n=({requiredPermission:r="orders",externalSource:i=null,pageTitle:m="Pedidos comerciales"})=>{O.externalSource=i||null;const d=s.useRef(),p=s.useRef(),w=s.useRef(),u=s.useRef(),h=s.useRef(),S=s.useRef(),I=s.useRef(),P=s.useRef(),E=s.useRef(),M=s.useRef(),q=s.useRef(),z=s.useRef(),T=s.useRef(),de=s.useRef(),B=s.useRef(),he=s.useRef(),f=s.useRef(),R=s.useRef(),U=s.useRef(),L=s.useRef(),te=s.useRef(),_e=s.useRef(),X=s.useRef(),Ve=s.useRef(),He=s.useRef(),Ke=s.useRef(),Qe=s.useRef(),Xe=s.useRef(),or=s.useRef(),W=s.useRef(),ge=s.useRef(),re=s.useRef(),xe=s.useRef(),ve=s.useRef(),Ye=s.useRef(),lt=s.useRef({}),[ar,lr]=s.useState(!1),[ye,Et]=s.useState(""),[V,Je]=s.useState(""),[H,Ze]=s.useState(""),[je,dt]=s.useState(""),[Ne,ut]=s.useState(""),[K,Ee]=s.useState(""),[dr,ue]=s.useState(""),[mt,pt]=s.useState({lat:"",lng:""}),[ur,et]=s.useState(""),[mr,Ft]=s.useState([]),[Fe,tt]=s.useState([]),[Rn,we]=s.useState([]),[Y,Q]=s.useState([Ue()]),[De,Dt]=s.useState("Factura"),[ne,ft]=s.useState(null),[It,pr]=s.useState(null),[Ce,fr]=s.useState(null),[Tt,bt]=s.useState(null),[me,ht]=s.useState(""),[N,_t]=s.useState({recipient_name:"",recipient_document_type:"DNI",recipient_document_number:"",recipient_phone:"",delivered_at:cr(),evidence_notes:"",evidence_url:"",latitude:"",longitude:""}),br=s.useMemo(()=>{var n;const e=new URLSearchParams;return ye&&e.append("business_id",ye),V&&e.append("business_branch_id",V),H&&e.append("warehouse_id",H),je&&e.append("client_id",je),Ne&&e.append("eventual_client_id",Ne),K&&e.append("client_distribution_network_id",K),(n=B.current)!=null&&n.value&&e.append("issue_date",B.current.value),`/api/admin/commercial-orders/articles?${e.toString()}`},[ye,V,H,je,Ne,K]),hr=s.useMemo(()=>V?["business_branch_id","=",Number(V)]:null,[V]);s.useEffect(()=>()=>{me!=null&&me.startsWith("blob:")&&URL.revokeObjectURL(me)},[me]),s.useEffect(()=>{if(!ne)return;const e=()=>ft(null),n=c=>{c.key==="Escape"&&e()};return document.addEventListener("click",e),document.addEventListener("keydown",n),window.addEventListener("resize",e),window.addEventListener("scroll",e,!0),()=>{document.removeEventListener("click",e),document.removeEventListener("keydown",n),window.removeEventListener("resize",e),window.removeEventListener("scroll",e,!0)}},[ne]);const At=e=>(lt.current[e]||(lt.current[e]=s.createRef()),lt.current[e]);s.useEffect(()=>{Y.forEach(e=>{const n=At(e.uid);!n.current||!e.article_id||!e.article_label||`${$(n.current).val()}`==`${e.article_id}`||Re(n.current,e.article_id,e.article_label)})},[Y]);const Pt=async(e,n=null)=>{if(!e){Ft([]),Je("");return}const l=(await O.getBranchesByBusiness(e)??[]).filter(a=>a.status!==null);if(Ft(l),n&&l.some(a=>`${a.id}`==`${n}`)){Je(`${n}`);return}Je("")},Ot=e=>{if(!e)return;const n=pn(e),c=fn(e);n&&W.current&&(W.current.value=n),c&&re.current&&(re.current.value=c),n&&et(n)},Mt=async(e,n=null,c=null)=>{var v;if(!e){tt([]),Ee(""),we([]),ue("");return}const a=(await O.getDistributionNetworks(e)??[]).filter(_=>_.status!==null);tt(a);const o=n||((v=a.find(_=>_.is_default))==null?void 0:v.id);if(o&&a.some(_=>`${_.id}`==`${o}`)){Ee(`${o}`),await Bt(o,null,a);return}Ee(""),we([]),ue(""),Ot(c)},Bt=async(e,n=null,c=null)=>{var _,j;if(!e){we([]),ue("");return}let l=[];const a=(c??Fe).find(g=>`${g.id}`==`${e}`);(((_=a==null?void 0:a.addresses)==null?void 0:_.length)??0)>0?l=a.addresses:l=await O.getDeliveryAddresses(e);const o=(l??[]).filter(g=>g.status!==null);we(o);const v=n||((j=o.find(g=>g.is_default))==null?void 0:j.id);if(v&&o.some(g=>`${g.id}`==`${v}`)){ue(`${v}`),_r(o.find(g=>`${g.id}`==`${v}`));return}ue("")},_r=e=>{e&&(W.current&&(W.current.value=C(e.address)),ge.current&&(ge.current.value=C(e.reference)),re.current&&(re.current.value=C(e.ubigeo)),xe.current&&(xe.current.value=C(e.contact_name)),ve.current&&(ve.current.value=C(e.contact_phone)),et(C(e.address)),ee({lat:e.latitude,lng:e.longitude})&&pt({lat:Number(e.latitude),lng:Number(e.longitude)}))},Lt=async(e,n={})=>{var o,v,_;const c=n.article_id??e.article_id,l=Number(n.quantity??e.quantity??0),a=n.presentation_id??e.presentation_id;return!c||!H||l<=0?null:await O.resolvePrice({article_id:c,presentation_id:a||null,quantity:l,business_id:ye||null,business_branch_id:V||null,warehouse_id:H||null,client_id:je||null,eventual_client_id:Ne||null,client_distribution_network_id:K||null,issue_date:((o=B.current)==null?void 0:o.value)||null,commercial_channel:((v=Fe.find(j=>`${j.id}`==`${K}`))==null?void 0:v.commercial_channel)||null,segment:((_=Fe.find(j=>`${j.id}`==`${K}`))==null?void 0:_.segment)||null})},gt=async(e=null)=>{const n=e??Y;for(const c of n){if(!c.article_id)continue;const l=await Lt(c);l&&Q(a=>a.map(o=>o.uid!==c.uid?o:be({...o,stock_available:Number(l.stock_available||0),price_unit:Yt(o,l),price_source:Jt(o,l),price_list_code:l.price_list_code||""})))}},Gt=e=>{e==="regular"?(ut(""),J(z)):e==="eventual"&&(dt(""),tt([]),Ee(""),we([]),ue(""),J(q))},xt=async(e=null)=>{var _,j,g,G;lr(!!(e!=null&&e.id)),S.current&&(S.current.value=(e==null?void 0:e.id)??""),I.current&&(I.current.value=(e==null?void 0:e.code)??"Se genera al guardar"),B.current&&(B.current.value=e!=null&&e.issue_date?e.issue_date.toString().slice(0,10):new Date().toISOString().slice(0,10)),he.current&&(he.current.value=e!=null&&e.promised_delivery_at?e.promised_delivery_at.toString().slice(0,10):""),Dt(st((e==null?void 0:e.document_type)??"Factura")),R.current&&(R.current.value=(e==null?void 0:e.currency)??"PEN"),U.current&&(U.current.value=(e==null?void 0:e.payment_condition)??"Contado"),L.current&&(L.current.value=mn(e==null?void 0:e.payment_method)),Ve.current&&(Ve.current.value=(e==null?void 0:e.installments)??1),He.current&&(He.current.value=e!=null&&e.first_due_date?e.first_due_date.toString().slice(0,10):""),Ke.current&&(Ke.current.value=(e==null?void 0:e.order_status)??(e!=null&&e.external_source?"pending":"draft")),Qe.current&&(Qe.current.value=(e==null?void 0:e.dispatch_status)??"pending"),Xe.current&&(Xe.current.value=(e==null?void 0:e.billing_status)??"pending"),W.current&&(W.current.value=C(e==null?void 0:e.delivery_address)),ge.current&&(ge.current.value=C(e==null?void 0:e.delivery_reference)),re.current&&(re.current.value=C(e==null?void 0:e.ubigeo)),xe.current&&(xe.current.value=C(e==null?void 0:e.dispatch_contact_name)),ve.current&&(ve.current.value=C(e==null?void 0:e.dispatch_contact_phone)),te.current&&(te.current.value=(e==null?void 0:e.purchase_order)??""),_e.current&&(_e.current.value=(e==null?void 0:e.guide_number)??""),X.current&&(X.current.value=(e==null?void 0:e.referral_guide)??""),de.current&&(de.current.value=(e==null?void 0:e.doctor_name)??""),Ye.current&&(Ye.current.value=(e==null?void 0:e.observations)??""),pt({lat:ee({lat:e==null?void 0:e.map_lat,lng:e==null?void 0:e.map_lng})?Number(e.map_lat):"",lng:ee({lat:e==null?void 0:e.map_lat,lng:e==null?void 0:e.map_lng})?Number(e.map_lng):""}),et(C(e==null?void 0:e.delivery_address));const n=e!=null&&e.business_id?`${e.business_id}`:"",c=e!=null&&e.warehouse_id?`${e.warehouse_id}`:"",l=e!=null&&e.client_id?`${e.client_id}`:"",a=e!=null&&e.eventual_client_id?`${e.eventual_client_id}`:"";Et(n),Ze(c),dt(l),ut(a),n&&((_=e==null?void 0:e.business)!=null&&_.name)?Re(P.current,n,e.business.name):J(P),c&&((j=e==null?void 0:e.warehouse)!=null&&j.name)?Re(M.current,c,e.warehouse.name):J(M),l&&((g=e==null?void 0:e.client)!=null&&g.full_name)?Re(q.current,l,`${e.client.document_number??""} - ${e.client.full_name}`.trim()):J(q),a&&((G=e==null?void 0:e.eventual_client)!=null&&G.business_name)?Re(z.current,a,`${e.eventual_client.document_number??""} - ${e.eventual_client.business_name}`.trim()):J(z),e!=null&&e.seller_id&&(e!=null&&e.seller)?Re(T.current,e.seller_id,Ct(e.seller)):J(T);const o=((e==null?void 0:e.items)??[]).map(y=>{var se,oe,ae,le,x,k,Ie,Te,Ae,Pe,Oe,Me,Be,Le,Ge,qe;const b=y.article??null,ce=((b==null?void 0:b.presentations)??[]).filter(F=>(F==null?void 0:F.status)!==!1&&(F==null?void 0:F.status)!==0),A=y.presentation??ce[0]??null,pe=Number(y.presentation_units??(A==null?void 0:A.units)??1)||1;return be({uid:crypto.randomUUID(),article_id:y.article_id?`${y.article_id}`:"",article_label:b?`${b.code??""} - ${b.name??""}`.trim():"",article_code:(b==null?void 0:b.code)??y.external_sku??"",article_lot:(b==null?void 0:b.default_lot)??"",article_name:(b==null?void 0:b.name)??"",article_unit:((se=b==null?void 0:b.unit)==null?void 0:se.symbol)??((oe=b==null?void 0:b.unit)==null?void 0:oe.name)??"",article_laboratory:((ae=b==null?void 0:b.laboratory)==null?void 0:ae.name)??"",article_principle:((le=b==null?void 0:b.activePrinciple)==null?void 0:le.name)??((x=b==null?void 0:b.active_principle)==null?void 0:x.name)??"",presentations:ce.map(F=>({id:`${F.id}`,name:F.name??"Presentacion",units:Number(F.units||1),price:Number(F.price||0)})),presentation_id:A!=null&&A.id?`${A.id}`:"",presentation_units:pe,stock_available:Number(y.stock_available||0),reserved_quantity:Number(y.reserved_quantity||0),price_unit:Number(y.price_unit||0),quantity:Number(y.quantity||1),discount_type:((Ie=(k=y.external_payload)==null?void 0:k.commercial_form)==null?void 0:Ie.discount_type)??"none",discount_value:Number(((Ae=(Te=y.external_payload)==null?void 0:Te.commercial_form)==null?void 0:Ae.discount_value)||0),discount_amount:Number(((Oe=(Pe=y.external_payload)==null?void 0:Pe.commercial_form)==null?void 0:Oe.discount_amount)||0),gross_total:Number(((Be=(Me=y.external_payload)==null?void 0:Me.commercial_form)==null?void 0:Be.gross_total)||0),total:Number(y.total||0),price_source:y.price_source||"fallback",price_list_code:((Ge=(Le=y==null?void 0:y.price_list_item)==null?void 0:Le.price_list)==null?void 0:Ge.code)||((qe=e==null?void 0:e.price_list)==null?void 0:qe.code)||""})}),v=o.length?o:[Ue()];Q(v),$(p.current).modal("show"),await Pt((e==null?void 0:e.business_id)??null,(e==null?void 0:e.business_branch_id)??null),l?(await Mt(l,(e==null?void 0:e.client_distribution_network_id)??null),e!=null&&e.client_distribution_network_id&&await Bt(e.client_distribution_network_id,(e==null?void 0:e.client_delivery_address_id)??null)):(tt([]),Ee(""),we([]),ue(""))},gr=async e=>{var a,o,v,_,j,g,G,y,b,ce,A,pe,se,oe,ae,le,x,k,Ie,Te,Ae,Pe,Oe,Me,Be,Le,Ge,qe,F,Wt,Vt,Ht,Kt;e.preventDefault();const n={id:((a=S.current)==null?void 0:a.value)||void 0,external_source:i||void 0,business_id:ye||null,business_branch_id:V||null,warehouse_id:H||null,client_id:je||null,eventual_client_id:Ne||null,seller_id:((o=T.current)==null?void 0:o.value)||null,client_distribution_network_id:K||null,client_delivery_address_id:dr||null,document_type:De,currency:((v=R.current)==null?void 0:v.value)||"PEN",payment_condition:un(((_=L.current)==null?void 0:_.value)||((j=U.current)==null?void 0:j.value)||"Contado"),payment_method:((g=L.current)==null?void 0:g.value)||"",purchase_order:((y=(G=te.current)==null?void 0:G.value)==null?void 0:y.trim())||"",guide_number:((ce=(b=_e.current)==null?void 0:b.value)==null?void 0:ce.trim())||"",referral_guide:((pe=(A=X.current)==null?void 0:A.value)==null?void 0:pe.trim())||"",doctor_name:((oe=(se=de.current)==null?void 0:se.value)==null?void 0:oe.trim())||"",issue_date:((ae=B.current)==null?void 0:ae.value)||"",promised_delivery_at:((le=he.current)==null?void 0:le.value)||null,installments:((x=Ve.current)==null?void 0:x.value)||1,first_due_date:((k=He.current)==null?void 0:k.value)||null,order_status:((Ie=Ke.current)==null?void 0:Ie.value)||(i?"pending":"draft"),dispatch_status:((Te=Qe.current)==null?void 0:Te.value)||"pending",billing_status:((Ae=Xe.current)==null?void 0:Ae.value)||"pending",tax_amount:jt.taxAmount,delivery_address:((Oe=(Pe=W.current)==null?void 0:Pe.value)==null?void 0:Oe.trim())||"",delivery_reference:((Be=(Me=ge.current)==null?void 0:Me.value)==null?void 0:Be.trim())||"",ubigeo:((Ge=(Le=re.current)==null?void 0:Le.value)==null?void 0:Ge.trim())||"",map_lat:at(mt.lat)||null,map_lng:at(mt.lng)||null,dispatch_contact_name:((F=(qe=xe.current)==null?void 0:qe.value)==null?void 0:F.trim())||"",dispatch_contact_phone:((Vt=(Wt=ve.current)==null?void 0:Wt.value)==null?void 0:Vt.trim())||"",observations:((Kt=(Ht=Ye.current)==null?void 0:Ht.value)==null?void 0:Kt.trim())||"",items:Y.map(D=>({article_id:D.article_id||null,presentation_id:D.presentation_id||null,warehouse_id:H||null,stock_available:D.stock_available,reserved_quantity:D.reserved_quantity,presentation_units:D.presentation_units,price_unit:D.price_unit,quantity:D.quantity,gross_total:D.gross_total,discount_type:D.discount_type,discount_value:D.discount_value,discount_amount:D.discount_amount,total:D.total,status:!0}))},c=gn(Y,H);if(c.length>0){const D=`
      ...
      `,{isConfirmed:Ar}=await Nt.fire({title:"Stock insuficiente",html:D,icon:"warning",showCancelButton:!0,confirmButtonText:"Crear de todas formas",cancelButtonText:"Revisar pedido"});if(!Ar)return;n.allow_stock_shortage=!0}await O.save(n)&&($(d.current).dxDataGrid("instance").refresh(),$(p.current).modal("hide"))},xr=async e=>{const n=e.target.value||"";Et(n),Ze(""),J(M),await Pt(n,null)},vr=e=>{const n=e.target.value||"";Je(n),Ze(""),J(M)},yr=async e=>{const n=e.target.value||"";Ze(n),await gt()},jr=async e=>{var l,a;const n=tr(e.target.value),c=((a=(l=$(e.target).select2("data"))==null?void 0:l[0])==null?void 0:a.data)??null;dt(n),Gt("regular"),Ot(c),await Mt(n,null,c),await gt()},Nr=async e=>{const n=tr(e.target.value);ut(n),Gt("eventual"),await gt()},qt=async({id:e,field:n,value:c})=>{await O.boolean({id:e,field:n,value:c})&&$(d.current).dxDataGrid("instance").refresh()},wr=e=>{pr(e),$(w.current).modal("show")},Cr=e=>{const n=$t(e);fr(e),bt(null),ht(ir(n==null?void 0:n.evidence_url)?n.evidence_url:""),_t({recipient_name:(n==null?void 0:n.recipient_name)??(e==null?void 0:e.dispatch_contact_name)??"",recipient_document_type:(n==null?void 0:n.recipient_document_type)??"DNI",recipient_document_number:(n==null?void 0:n.recipient_document_number)??"",recipient_phone:(n==null?void 0:n.recipient_phone)??(e==null?void 0:e.dispatch_contact_phone)??"",delivered_at:n!=null&&n.delivered_at?`${n.delivered_at}`.replace(" ","T").slice(0,16):cr(),evidence_notes:(n==null?void 0:n.evidence_notes)??"",evidence_url:(n==null?void 0:n.evidence_url)??"",latitude:(n==null?void 0:n.latitude)??"",longitude:(n==null?void 0:n.longitude)??""}),navigator.geolocation&&navigator.geolocation.getCurrentPosition(c=>{_t(l=>({...l,latitude:l.latitude||c.coords.latitude,longitude:l.longitude||c.coords.longitude}))},()=>{},{enableHighAccuracy:!0,timeout:5e3}),setTimeout(()=>{h.current&&(h.current.value="")},0),$(u.current).modal("show")},$r=e=>{var c;const n=((c=e.target.files)==null?void 0:c[0])??null;bt(n),ht(n?URL.createObjectURL(n):ir(N.evidence_url)?N.evidence_url:"")},ie=(e,n)=>_t(c=>({...c,[e]:n})),Rr=async e=>{if(e.preventDefault(),!(Ce!=null&&Ce.id))return;const n=(Ce.dispatch_assignments??Ce.dispatchAssignments??[]).filter(a=>(a==null?void 0:a.status)!==!1&&(a==null?void 0:a.status)!==0&&(a==null?void 0:a.dispatch)).sort((a,o)=>{var v,_;return new Date(((v=o==null?void 0:o.dispatch)==null?void 0:v.scheduled_date)||(o==null?void 0:o.created_at)||0)-new Date(((_=a==null?void 0:a.dispatch)==null?void 0:_.scheduled_date)||(a==null?void 0:a.created_at)||0)})[0],c=new FormData;n!=null&&n.dispatch_id&&c.append("dispatch_id",n.dispatch_id),c.append("recipient_name",N.recipient_name??""),c.append("recipient_document_type",N.recipient_document_type??"DNI"),c.append("recipient_document_number",N.recipient_document_number??""),c.append("recipient_phone",N.recipient_phone??""),c.append("delivered_at",N.delivered_at??""),c.append("evidence_notes",N.evidence_notes??""),c.append("evidence_url",N.evidence_url??""),c.append("latitude",N.latitude??""),c.append("longitude",N.longitude??""),Tt&&c.append("evidence_file",Tt),await O.saveDeliveryEvidence(Ce.id,c)&&(bt(null),ht(""),h.current&&(h.current.value=""),$(u.current).modal("hide"),$(d.current).dxDataGrid("instance").refresh())},kr=async e=>{const n=ot(e)[0];if(n){if(xn(n)){const l=await Nt.fire({title:"Guia de remision",text:`La guia ${kt(n)} esta ${sr(n.guide_status).toLowerCase()}.`,icon:"question",showCancelButton:!0,showDenyButton:!0,confirmButtonText:"Emitir",denyButtonText:"Ver PDF",cancelButtonText:"Cancelar"});if(l.isConfirmed){const a=await Xt.issue(n.id);if(!(a!=null&&a.data))return;$(d.current).dxDataGrid("instance").refresh(),await rt(nt.referralGuide(a.data));return}if(!l.isDenied)return}await rt(nt.referralGuide(n));return}const c=await Xt.prepareFromCommercialOrder(e.id);c!=null&&c.data&&($(d.current).dxDataGrid("instance").refresh(),await rt(nt.referralGuide(c.data)))},Sr=async e=>{const{isConfirmed:n}=await Nt.fire({title:"Eliminar pedido comercial",text:"Estas seguro de eliminar este pedido comercial? Esta accion no se puede revertir",icon:"warning",showCancelButton:!0,confirmButtonText:"Si, eliminar",cancelButtonText:"Cancelar"});!n||!await O.delete(e)||$(d.current).dxDataGrid("instance").refresh()},Er=async(e,n)=>{var y,b,ce,A,pe,se,oe,ae,le;$(n.target).data("select2")&&$(n.target).select2("close");const c=(y=$(n.target).select2("data"))==null?void 0:y[0],l=(c==null?void 0:c.data)??null,a=n.target.value||"";if(!a){Q(x=>x.map(k=>k.uid===e?{...Ue(),uid:k.uid}:k));return}const o=l??await O.getArticleById(a),v=((o==null?void 0:o.presentations)??[]).filter(x=>(x==null?void 0:x.status)!==!1&&(x==null?void 0:x.status)!==0),_=v[0]??null,j=o?`${o.code??""} - ${o.name??""}`.trim():(c==null?void 0:c.text)??a,g={article_id:a,article_label:j,article_code:(o==null?void 0:o.code)??"",article_lot:(o==null?void 0:o.default_lot)??"",article_name:(o==null?void 0:o.name)??"",article_unit:((b=o==null?void 0:o.unit)==null?void 0:b.symbol)??((ce=o==null?void 0:o.unit)==null?void 0:ce.name)??"",article_laboratory:((A=o==null?void 0:o.laboratory)==null?void 0:A.name)??"",article_principle:((pe=o==null?void 0:o.activePrinciple)==null?void 0:pe.name)??((se=o==null?void 0:o.active_principle)==null?void 0:se.name)??"",presentations:v.map(x=>({id:`${x.id}`,name:x.name??"Presentacion",units:Number(x.units||1),price:Number(x.price||0)})),presentation_id:_?`${_.id}`:"",presentation_units:Number((_==null?void 0:_.units)||1),quantity:1};Q(x=>x.map(k=>k.uid===e?be({...k,...g}):k));const G=await O.resolvePrice({article_id:a,presentation_id:_?`${_.id}`:null,quantity:1,business_id:ye||null,business_branch_id:V||null,warehouse_id:H||null,client_id:je||null,eventual_client_id:Ne||null,client_distribution_network_id:K||null,issue_date:((oe=B.current)==null?void 0:oe.value)||null,commercial_channel:((ae=Fe.find(x=>`${x.id}`==`${K}`))==null?void 0:ae.commercial_channel)||null,segment:((le=Fe.find(x=>`${x.id}`==`${K}`))==null?void 0:le.segment)||null});G&&Q(x=>x.map(k=>k.uid===e?be({...k,...g,stock_available:Number(G.stock_available||0),price_unit:Number(G.price_unit||0),price_source:G.source||"fallback",price_list_code:G.price_list_code||""}):k))},vt=async(e,n,c)=>{const l=Y.find(j=>j.uid===e);if(!l)return;const a=n==="presentation_id"?l.presentations.find(j=>`${j.id}`==`${c}`):null,o=be({...l,[n]:c,...n==="presentation_id"?{presentation_units:Number((a==null?void 0:a.units)||1)}:{}});if(n==="price_unit"&&(o.price_source="manual",o.price_list_code=""),Q(j=>j.map(g=>g.uid===e?o:g)),!["quantity","presentation_id"].includes(n))return;const v=o.presentations.find(j=>`${j.id}`==`${n==="presentation_id"?c:o.presentation_id}`),_=await Lt(o,{quantity:n==="quantity"?c:o.quantity,presentation_id:n==="presentation_id"?c:o.presentation_id});_&&Q(j=>j.map(g=>g.uid!==e?g:be({...g,presentation_units:Number((v==null?void 0:v.units)||g.presentation_units||1),stock_available:Number(_.stock_available||0),price_unit:Yt(g,_,n==="presentation_id"),price_source:Jt(g,_,n==="presentation_id"),price_list_code:n==="presentation_id"?_.price_list_code||"":St(g)?g.price_list_code:_.price_list_code||""})))},Fr=(e,n)=>{const c=Number(n||0);Q(l=>l.map(a=>a.uid!==e?a:be({...a,discount_type:c>0?"percent":"none",discount_value:c>0?c:0})))},Dr=(e,n)=>{n.preventDefault(),n.stopPropagation();const c=n.currentTarget.getBoundingClientRect();ft(l=>(l==null?void 0:l.uid)===e?null:{uid:e,top:c.bottom+4,left:c.left,width:Math.max(c.width,130)})},zt=(e,n)=>{Fr(e,n),ft(null)},Ir=()=>Q(e=>[...e,Ue()]),Tr=e=>{Q(n=>{const c=n.filter(l=>l.uid!==e);return c.length?c:[Ue()]})},yt=s.useMemo(()=>Y.reduce((e,n)=>e+Number(n.total||0),0),[Y]),jt=s.useMemo(()=>nr(yt,De),[yt,De]),Ut=s.useMemo(()=>Cn(It),[It]);return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
