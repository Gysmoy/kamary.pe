var os=Object.defineProperty;var ls=(i,l,u)=>l in i?os(i,l,{enumerable:!0,configurable:!0,writable:!0,value:u}):i[l]=u;var R=(i,l,u)=>ls(i,typeof l!="symbol"?l+"":l,u);import{m as cs,t as ds,C as us,c as ms,j as e,r as d,S as N}from"./CreateReactScript-DFm9HKt4.js";import{B as ps}from"./Base-LtinHIm3.js";import{T as gs}from"./Table-BkkKBRcX.js";import{M as ze}from"./Modal-CIzBBpxt.js";import{D as Le}from"./DxButton-CsjWvhyj.js";import{B as hs}from"./BasicRest-DTFVycYX.js";import{a as K}from"./permissionScope-BUDcDFo2.js";import{r as Nt}from"./renderGridEditLink-D8NGEeKJ.js";import{o as xs,b as fs}from"./magistralesRecordPdf-yxz4lped.js";import{t as Ae,D as bs,u as vs}from"./statusLabels-BIn8QltQ.js";import"./ubigeoInei-D0FnAslC.js";const le=async(i,l={})=>{try{const{status:u,result:g}=await cs.Fetch(i,{method:"POST",body:JSON.stringify({take:1e3,skip:0,isLoadingAll:!0,...l})});if(!u)throw new Error((g==null?void 0:g.message)||"No se pudo cargar la lista");return(g==null?void 0:g.data)??[]}catch(u){return ds.error("Error",{description:u.message,duration:3e3,richColors:!0}),[]}},js=()=>location.pathname.includes("/admin/storage-general-service-orders"),ys=()=>location.pathname.includes("/admin/storage-service-orders");class _s extends hs{constructor(){super(...arguments);R(this,"path",K()?js()?"admin/storage/general-service-orders":"admin/storage/service-orders":"admin/service-orders");R(this,"deleted",!1);R(this,"getBranchesByBusiness",async u=>u?await this.simpleGet(`/api/${this.path}/businesses/${u}/branches`)??[]:[]);R(this,"getBusinesses",async()=>await le("/api/admin/businesses/paginate"));R(this,"getClients",async()=>await le(K()?"/api/admin/storage/clients/paginate":"/api/admin/services-client/paginate"));R(this,"getServices",async()=>await le(K()?"/api/admin/storage/general-service/paginate":"/api/admin/services/paginate",ys()?{storage_service_types:!0}:{}));R(this,"getStorageOptions",async()=>K()?await this.simpleGet("/api/admin/storage/kardex/options"):null);R(this,"getStorageWarehouses",async()=>K()?await le("/api/admin/storage/kardex/paginate",{section:"warehouses",sort:[{selector:"warehouse_name",desc:!1}]}):[]);R(this,"getStorageLocations",async()=>K()?await le("/api/admin/storage/kardex/paginate",{section:"locations"}):[])}async paginate(u){return await super.paginate({...u,deleted:this.deleted})}}const b=new _s,St=i=>(i==null?void 0:i.fullname)||[i==null?void 0:i.name,i==null?void 0:i.lastname].filter(Boolean).join(" ")||(i==null?void 0:i.username)||"",ce=()=>({uid:crypto.randomUUID(),service_id:"",scope:"",gloss:"",description:"",quantity:1,unit_price:0,detraction_percent:0,commission_percent:0,total:0}),S=(i="")=>i.toString().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]/g,""),Ns=["Servicio de almacenamiento","Servicio de almacenamiento - Adicional"],Ss=[{value:"PEN",label:"Soles"},{value:"USD",label:"Dolares"}],wt=i=>(i==null?void 0:i.name)??(i==null?void 0:i.warehouse_name)??"",Cs=i=>(i==null?void 0:i.id)??(i==null?void 0:i.warehouse_id)??"",ws=i=>i==="approved"?"Aprobado":vs(i),Fs=i=>{const l=Cs(i),u=wt(i);return{key:l?`warehouse-${l}`:S(u),warehouse_name:u,warehouse_id:l?`${l}`:"",enabled:!1,location_id:"",location_ids:[],location_label:"",location_labels:[],start_date:"",months:"",end_date:"",billing_dates:[],quantity_m3:"",tariff:"",monthly_amount:""}},$e=(i=[])=>i.filter(l=>(l==null?void 0:l.status)!==null).map(Fs),Me=i=>{var l,u,g;return((g=(l=i==null?void 0:i.toString)==null?void 0:(u=l.call(i)).slice)==null?void 0:g.call(u,0,10))??""},de=i=>Number(i||0),We=(i,l,u=!1)=>{if(!i)return"";const g=Number(l);if(!Number.isFinite(g)||g<0||!u&&g<=0)return"";const _=new Date(`${i}T00:00:00`);if(Number.isNaN(_.getTime()))return"";const v=new Date(_),D=v.getDate();return v.setDate(1),v.setMonth(v.getMonth()+g),v.setDate(Math.min(D,new Date(v.getFullYear(),v.getMonth()+1,0).getDate())),v.toISOString().slice(0,10)},Ct=(i,l)=>{const u=Number.parseInt(l,10);return!i||!Number.isFinite(u)||u<=0?[]:Array.from({length:u},(g,_)=>({month:_+1,date:We(i,_,!0)}))},E=i=>i?[i.code,i.temperature_range].filter(Boolean).join(" | "):"",Ft=(i="")=>i.split(",").map(l=>l.trim()).filter(Boolean),Re=i=>Array.isArray(i.location_ids)?i.location_ids.filter(Boolean).map(l=>`${l}`):i.location_id?[`${i.location_id}`]:[],$s=(i,l)=>[i.warehouse_name,(Array.isArray(l)?l.map(E).filter(Boolean).join(", "):E(l))||i.location_label,`${i.start_date||""} - ${i.end_date||""}`,`${i.months||0} meses`,`${i.quantity_m3||0} m3`].filter(Boolean).join("; "),Rs=(i="")=>{const l=i.split(";").map(g=>g.trim()),u=(l[2]??"").split("-").map(g=>g.trim());return{warehouse_name:l[0]??"",location_label:l[1]??"",location_labels:Ft(l[1]??""),start_date:u.length>=3?`${u[0]}-${u[1]}-${u[2]}`.slice(0,10):"",end_date:u.length>=6?`${u[3]}-${u[4]}-${u[5]}`.slice(0,10):"",months:parseFloat(l[3])||"",quantity_m3:parseFloat(l[4])||""}},Bs=({moduleTitle:i="Ordenes de servicio",serviceOrderType:l="service"})=>{const u=d.useRef(),g=d.useRef(),_=d.useRef(),v=d.useRef(),D=d.useRef(),J=d.useRef(),Y=d.useRef(),B=d.useRef(),C=d.useRef(),P=d.useRef(),ue=d.useRef(),Q=d.useRef(),X=d.useRef(),me=d.useRef(),z=d.useRef(),L=d.useRef(),Z=d.useRef(),A=d.useRef(),Be=d.useRef(null),ee=d.useRef(),pe=d.useRef(),te=d.useRef(),Ge=d.useRef(),[ge,$t]=d.useState([]),[Is,Rt]=d.useState([]),[he,Bt]=d.useState([]),[xe,It]=d.useState([]),[M,fe]=d.useState(""),[W,se]=d.useState(""),[re,be]=d.useState(""),[Ue,Ve]=d.useState(""),[Dt,He]=d.useState("PEN"),[Ie,Ke]=d.useState(!1),[T,Je]=d.useState("services"),[ve,Ye]=d.useState(""),[je,Qe]=d.useState(""),[ye,Xe]=d.useState(""),[Ze,et]=d.useState(null),[_e,tt]=d.useState({penTotal:0,penBilled:0,usdTotal:0,usdBilled:0}),[ie,k]=d.useState([ce()]),[G,Tt]=d.useState([]),[U,kt]=d.useState([]),[st,Ne]=d.useState(()=>$e()),[rt,Ot]=d.useState(!1),[qt,it]=d.useState(""),[Et,Pt]=d.useState(!1),ne=l==="storage_general",w=l==="storage_service",F=ne||w,j=!F,zt=xe.filter(t=>Ns.some(s=>S(s)===S(t.name))),De=Object.fromEntries(xe.map(t=>[`${t.id}`,t])),nt=async()=>{if(!w)return{warehouseRows:[],locationRows:[]};Be.current||(Be.current=(async()=>{const r=await b.getStorageOptions();let a=((r==null?void 0:r.warehouses)??[]).filter(c=>c.status!==null),o=((r==null?void 0:r.locations)??[]).filter(c=>c.status!==null);if(!a.length||!o.length){const[c,p]=await Promise.all([o.length?Promise.resolve(o):b.getStorageLocations(),a.length?Promise.resolve(a):b.getStorageWarehouses()]);a=(a.length?a:p??[]).filter(n=>n.status!==null),o=(o.length?o:c??[]).filter(n=>n.status!==null)}return{warehouseRows:a,locationRows:o}})());const{warehouseRows:t,locationRows:s}=await Be.current;return Tt(t),kt(s),Ot(!0),{warehouseRows:t,locationRows:s}};d.useEffect(()=>{(async()=>{var n;const s=w?nt():Promise.resolve({warehouseRows:[],locationRows:[]}),[r,a,o,c]=await Promise.all([b.getBusinesses(),b.getClients(),b.getServices(),s]),p=r??[];if($t(p),Bt((a??[]).filter(m=>m.status!==null)),It((o??[]).filter(m=>m.status!==null)),w&&Ne($e(c.warehouseRows)),w||j){const m=p[0];if(m){fe(`${m.id}`);const y=await Se(m.id);(n=y[0])!=null&&n.id&&se(`${y[0].id}`)}}})()},[]),d.useLayoutEffect(()=>{if(!j)return;b.deleted=T==="deleted",tt({penTotal:0,penBilled:0,usdTotal:0,usdBilled:0});const t=u.current?$(u.current).dxDataGrid("instance"):null;t&&(t.pageIndex(0),t.getDataSource().reload())},[T]);const Lt=()=>{const t=[];ve&&t.push(["client_id","=",Number(ve)]),je&&t.push(["created_at",">=",`${je} 00:00:00`]),ye&&t.push(["created_at","<=",`${ye} 23:59:59`]),et(t.length?t.reduce((s,r)=>s.length?[...s,"and",r]:r,[]):null)},At=()=>{Ye(""),Qe(""),Xe(""),et(null)},Mt=t=>{const r=((t==null?void 0:t.data)??[]).reduce((a,o)=>{const c=`${o.currency??"PEN"}`.toUpperCase(),p=Number(o.total||0),n=o.billing_status==="billed"||o.order_status==="invoiced"?p:Number(o.paid_amount||0);return c==="USD"?(a.usdTotal+=p,a.usdBilled+=n):(a.penTotal+=p,a.penBilled+=n),a},{penTotal:0,penBilled:0,usdTotal:0,usdBilled:0});tt(r)},Se=async(t,s="")=>{const a=await b.getBranchesByBusiness(t)??[];return Rt(a),se(s?`${s}`:""),a},at=t=>({...t,total:Number(t.quantity||0)*Number(t.unit_price||0)}),O=(t,s="")=>{var r;return((r=t.current)==null?void 0:r.value)||s||""},ot=(t="")=>{const s=`${t??""}`.trim(),r=s.match(/^client-(\d+)$/i);return r?r[1]:s},lt=(t,s=G)=>s.find(r=>S(wt(r))===S(t)),ct=(t,s=G)=>{var r;return t.warehouse_id||((r=lt(t.warehouse_name,s))==null?void 0:r.id)||""},dt=(t,s=U,r=G)=>{const a=ct(t,r);return s.filter(o=>a&&`${o.warehouse_id}`==`${a}`?!0:S(o.warehouse_name)===S(t.warehouse_name))},ut=(t,s=U,r=G)=>{const a=dt(t,s,r),o=Re(t),c=o.length?a.filter(n=>o.includes(`${n.id}`)):[];return c.length?c:(Array.isArray(t.location_labels)&&t.location_labels.length?t.location_labels:Ft(t.location_label)).map(n=>a.find(m=>S(E(m))===S(n))).filter(Boolean)},Wt=(t=[],s=G,r=U)=>{const a=$e(s);return t.forEach(o=>{var y,h;const c=Rs(o.description??""),p=a.findIndex(I=>S(I.warehouse_name)===S(c.warehouse_name));if(p<0)return;const n={...a[p],enabled:!0,warehouse_id:((y=lt(a[p].warehouse_name,s))==null?void 0:y.id)??a[p].warehouse_id,location_label:c.location_label,location_labels:c.location_labels,start_date:c.start_date,months:c.months||"",end_date:c.end_date||We(c.start_date,c.months),billing_dates:Ct(c.start_date,c.months),quantity_m3:c.quantity_m3||Number(o.quantity||0)||"",tariff:Number(o.unit_price||0)||"",monthly_amount:Number(o.total||0)||""},m=ut(n,r,s);a[p]={...n,location_id:(h=m[0])!=null&&h.id?`${m[0].id}`:"",location_ids:m.map(I=>`${I.id}`)}}),a},V=(t,s)=>{Ne(r=>r.map(a=>{if(a.key!==t)return a;const o="location_ids"in s?(Array.isArray(s.location_ids)?s.location_ids:[s.location_ids]).filter(Boolean).map(m=>`${m}`):null,c=s.location_id?U.find(m=>`${m.id}`==`${s.location_id}`):null,p=o?U.filter(m=>o.includes(`${m.id}`)):null,n={...a,...s,warehouse_id:ct(a)};if(c&&(n.location_label=E(c)),p&&(n.location_ids=o,n.location_id=o[0]??"",n.location_labels=p.map(E).filter(Boolean),n.location_label=n.location_labels.join(", ")),("start_date"in s||"months"in s)&&(n.end_date=We(n.start_date,n.months),n.billing_dates=Ct(n.start_date,n.months)),"quantity_m3"in s||"tariff"in s){const m=de(n.quantity_m3)*de(n.tariff);n.monthly_amount=m?m.toFixed(2):""}return n}))},Gt=(t,s,r)=>{Ne(a=>a.map(o=>o.key!==t?o:{...o,billing_dates:(o.billing_dates??[]).map((c,p)=>p===s?{...c,date:r}:c)}))},Ut=(t,s)=>{const r=`${s}`,a=Re(t),o=a.includes(r)?a.filter(c=>c!==r):[...a,r];V(t.key,{location_ids:o})},ae=async(t=null)=>{var n,m,y;Pt(!!(t!=null&&t.id)),_.current.value=(t==null?void 0:t.id)??"",v.current.value=(t==null?void 0:t.code)??"Se genera al guardar",D.current.value=Me(t==null?void 0:t.issue_date)||new Date().toISOString().slice(0,10),J.current.value=Me(t==null?void 0:t.scheduled_at),Y.current.value=Me(t==null?void 0:t.first_due_date),B.current.value=(t==null?void 0:t.expected_document_type)??(F?"":"Factura");const s=(t==null?void 0:t.currency)??(F?"":"PEN");C.current.value=s,He(s||"PEN"),P.current.value=(t==null?void 0:t.billing_cycle)??(j?"Unico":""),ue.current&&(ue.current.value=(t==null?void 0:t.contract_label)??""),Q.current.value=(t==null?void 0:t.payment_condition)??"Contado",X.current.value=Number((t==null?void 0:t.installments)??1),me.current&&(me.current.value=(t==null?void 0:t.billing_day)??""),z.current.value=(t==null?void 0:t.order_status)??(ne?"approved":"draft"),L.current.value=(t==null?void 0:t.billing_status)??"pending",Z.current.value=Number((t==null?void 0:t.tax_amount)??0),A.current.value=(t==null?void 0:t.observations)??"",Ke(!!((t==null?void 0:t.detraction_enabled)??((t==null?void 0:t.items)??[]).some(h=>Number(h.detraction_percent||0)>0)));const r=t!=null&&t.business_id?`${t.business_id}`:M||((n=ge[0])!=null&&n.id?`${ge[0].id}`:"");fe(r),be(t!=null&&t.client_id?`${t.client_id}`:"");const a=await Se(r,(t==null?void 0:t.business_branch_id)??W);!(t!=null&&t.business_branch_id)&&!W&&((m=a[0])!=null&&m.id)&&se(`${a[0].id}`);const o=((t==null?void 0:t.items)??[]).map(h=>{var I,oe;return{uid:crypto.randomUUID(),service_id:`${h.service_id}`,scope:h.scope??((I=h.service)==null?void 0:I.category)??"",gloss:h.gloss??h.description??((oe=h.service)==null?void 0:oe.name)??"",description:h.description??"",quantity:Number(h.quantity||0),unit_price:Number(h.unit_price||0),detraction_percent:Number(h.detraction_percent||0),commission_percent:Number(h.commission_percent||0),total:Number(h.total||0)}});Ve(((y=o[0])==null?void 0:y.service_id)??"");let c=G,p=U;if(w&&(!c.length||!p.length||!rt)){const h=await nt();c=h.warehouseRows,p=h.locationRows}Ne(w?Wt((t==null?void 0:t.items)??[],c,p):$e()),k(o.length?o:ne?[]:[ce()]),$(g.current).modal("show")},q=(t,s,r)=>{k(a=>a.map(o=>{var p;if(o.uid!==t)return o;const c={...o,[s]:r};if(s==="service_id"){const n=De[r];c.scope=c.scope||(n==null?void 0:n.category)||"",c.gloss=c.gloss||(n==null?void 0:n.name)||"",c.description=c.gloss||c.description||(n==null?void 0:n.name)||"",c.unit_price=Number(((p=C.current)==null?void 0:p.value)==="USD"?n==null?void 0:n.unit_price_usd:n==null?void 0:n.unit_price_pen)||0}return s==="gloss"&&(c.description=r),at(c)}))},mt=t=>{He(t||"PEN"),k(s=>s.map(r=>{if(!r.service_id)return r;const a=De[r.service_id];return at({...r,unit_price:Number(t==="USD"?a==null?void 0:a.unit_price_usd:a==null?void 0:a.unit_price_pen)||0})}))},pt=t=>{N.fire({icon:"success",title:"Correcto",text:(t==null?void 0:t.message)||"Orden de servicio guardada correctamente.",timer:1800,showConfirmButton:!1})},gt=async t=>{const s=b.showSavedMessage;b.showSavedMessage=!1;try{return await b.save(t)}finally{b.showSavedMessage=s}},Te=async t=>{var y,h,I,oe;if(t.preventDefault(),w){const f=O(ee,M),we=O(pe,W),ft=ot(O(te,re)),qe=O(Ge,Ue),H=st.filter(x=>x.enabled),bt=H.find(x=>!Re(x).length||!x.start_date||!x.months||!x.end_date||!x.quantity_m3||!x.tariff);if(!f||!we||!ft||!B.current.value||!C.current.value||!qe){N.fire("Formulario incompleto","Completa empresa, cliente, tipo documento, moneda y tipo de servicio.","warning");return}if(!H.length){N.fire("Formulario incompleto","Selecciona al menos un almacen.","warning");return}if(bt){N.fire("Formulario incompleto",`Completa los datos de ${bt.warehouse_name}.`,"warning");return}const vt=H.find(x=>{const Pe=Number.parseInt(x.months,10);return!Array.isArray(x.billing_dates)||x.billing_dates.length!==Pe||x.billing_dates.some(Fe=>!Fe.date)});if(vt){N.fire("Formulario incompleto",`Completa las fechas de facturacion de ${vt.warehouse_name}.`,"warning");return}const jt=H.map(x=>x.start_date).filter(Boolean).sort(),rs=Math.max(...H.map(x=>Number(x.months||1))),Ee=De[qe],is={id:_.current.value||void 0,business_id:f||null,business_branch_id:we||null,client_id:ft||null,expected_document_type:B.current.value,currency:C.current.value,billing_cycle:(Ee==null?void 0:Ee.name)??"",payment_condition:"Contado",installments:rs||1,issue_date:D.current.value||new Date().toISOString().slice(0,10),scheduled_at:jt[0]??null,first_due_date:jt[0]??null,order_status:z.current.value||"draft",billing_status:L.current.value||"pending",tax_amount:0,observations:A.current.value.trim(),items:H.map(x=>{const Pe=ut(x),Fe=de(x.quantity_m3),_t=de(x.tariff),ns=de(x.monthly_amount)||Fe*_t;return{service_id:qe,description:$s(x,Pe),quantity:Fe,unit_price:_t,detraction_percent:0,commission_percent:0,total:ns,billing_dates:(x.billing_dates??[]).map(as=>as.date)}})},yt=await gt(is);if(!yt)return;$(u.current).dxDataGrid("instance").refresh(),$(g.current).modal("hide"),pt(yt);return}const s=O(ee,M),r=O(pe,W),a=ot(O(te,re)),o=ie.filter(f=>f.service_id).map(f=>({service_id:f.service_id,scope:f.scope,gloss:f.gloss,description:f.gloss||f.description,quantity:f.quantity,unit_price:f.unit_price,detraction_percent:j&&Ie?f.detraction_percent||12:f.detraction_percent,commission_percent:f.commission_percent,total:f.total}));if(ne){if(!s||!r||!a||!B.current.value||!C.current.value){N.fire("Formulario incompleto","Completa empresa, cliente, tipo documento y moneda.","warning");return}if(!o.length){N.fire("Formulario incompleto","Agrega al menos un servicio general.","warning");return}}else if(j){if(!s||!r||!a||!B.current.value||!C.current.value||!P.current.value){N.fire("Formulario incompleto","Completa cliente, comprobante, moneda y ciclo de facturacion.","warning");return}if(!o.length){N.fire("Formulario incompleto","Agrega al menos un item de servicio.","warning");return}}const c=o.reduce((f,we)=>f+Number(we.total||0),0),p=Number(j?(c*.18).toFixed(2):Z.current.value||0),n={id:_.current.value||void 0,business_id:s||null,business_branch_id:r||null,client_id:a||null,contract_label:((I=(h=(y=ue.current)==null?void 0:y.value)==null?void 0:h.trim)==null?void 0:I.call(h))||null,expected_document_type:B.current.value,currency:C.current.value,billing_cycle:P.current.value.trim(),payment_condition:Q.current.value,installments:X.current.value,billing_day:((oe=me.current)==null?void 0:oe.value)||null,detraction_enabled:j?Ie:!1,issue_date:D.current.value,scheduled_at:J.current.value||null,first_due_date:Y.current.value||null,order_status:z.current.value,billing_status:L.current.value,tax_amount:p,observations:A.current.value.trim(),items:o},m=await gt(n);m&&($(u.current).dxDataGrid("instance").refresh(),$(g.current).modal("hide"),pt(m))},Vt=async t=>{const{isConfirmed:s}=await N.fire({title:"Anular orden de servicio",text:"Se dara de baja la orden de servicio.",icon:"warning",showCancelButton:!0,confirmButtonText:"Si, anular",cancelButtonText:"Cancelar"});!s||!await b.delete(t)||$(u.current).dxDataGrid("instance").refresh()},Ht=(t,{data:s})=>{const r=(s==null?void 0:s.order_status)??"",a=document.createElement("span");a.className=`badge ${r==="approved"?"bg-soft-success text-success":r==="cancelled"?"bg-soft-danger text-danger":"bg-soft-warning text-warning"}`,a.textContent=ws(r),t.append(a)},Kt=(t,{data:s})=>{const r=(s==null?void 0:s.billing_status)==="billed"||(s==null?void 0:s.order_status)==="invoiced",a=document.createElement("span");a.className=`badge ${r?"bg-soft-success text-success":"bg-soft-warning text-warning"}`,a.textContent=r?"Facturado":"Pendiente",t.append(a)},Jt=t=>(t.items??[]).map(s=>{var r;return s.gloss||s.description||((r=s.service)==null?void 0:r.name)}).filter(Boolean).join(" | "),Yt=t=>(t==null?void 0:t.billing_status)==="billed"||(t==null?void 0:t.order_status)==="invoiced"?Number((t==null?void 0:t.total)||0):0,ht={caption:"Acciones",width:F?136:150,minWidth:F?136:150,fixed:F,fixedPosition:"left",allowFiltering:!1,allowExporting:!1,cellTemplate:(t,{data:s})=>{t.css({overflow:"visible",textOverflow:"unset",whiteSpace:"nowrap"});const r=$("<div>").css({display:"flex",alignItems:"center",gap:"0.35rem",minWidth:"max-content"});t.append(r),r.append(Le({className:F?"btn btn-xs btn-soft-warning":"btn btn-xs btn-soft-primary",title:"Editar orden de servicio",icon:"mdi mdi-pencil",onClick:()=>ae(s)})),F||r.append(Le({className:"btn btn-xs btn-soft-danger",title:"Imprimir PDF",icon:"mdi mdi-file-pdf-box",onClick:()=>xs(fs.serviceOrder(s))})),r.append(Le({className:"btn btn-xs btn-soft-danger",title:"Anular orden de servicio",icon:F?"mdi mdi-close":"mdi mdi-delete",onClick:()=>Vt(s.id)}))}},Qt=[{dataField:"row_number",caption:"#",width:56,allowFiltering:!1,calculateCellValue:t=>t.id},ht,{dataField:"billing_status",caption:"Estado",width:130,lookup:Ae([{value:"pending",label:"Pendiente"},{value:"billed",label:"Facturado"}]),cellTemplate:Kt},{dataField:"code",caption:"Orden Servicio",width:150,cellTemplate:(t,{data:s})=>Nt(t,s==null?void 0:s.code,()=>ae(s),"Editar orden de servicio")},{dataField:"billing_cycle",caption:"Ciclo Facturación",width:155},{dataField:"client.document_number",caption:"Doc. Cliente",width:140},{dataField:"client.full_name",caption:"Cliente",minWidth:200},{dataField:"services_text",caption:"Servicios",minWidth:260,calculateCellValue:Jt},{dataField:"total_prefactures",caption:"Total Prefacturas",width:150,dataType:"number",format:{type:"fixedPoint",precision:2},calculateCellValue:t=>Number(t.total||0)},{dataField:"total",caption:"Total Servicio",width:145,dataType:"number",format:{type:"fixedPoint",precision:2}},{dataField:"total_billed",caption:"Total Facturado",width:150,dataType:"number",format:{type:"fixedPoint",precision:2},calculateCellValue:Yt},{dataField:"contract_label",caption:"Contrato",width:150},{dataField:"creator.fullname",caption:"Usuario Registro",minWidth:150,calculateCellValue:t=>St(t.creator)},{dataField:"created_at",caption:"Fecha Registro",dataType:"datetime",width:170,format:"yyyy-MM-dd HH:mm:ss"}],Xt=[ht,{dataField:"order_status",caption:"Estado",width:145,minWidth:145,lookup:Ae(bs),cellTemplate:Ht},{dataField:"code",caption:"Codigo",width:185,minWidth:185,cellTemplate:(t,{data:s})=>Nt(t,s==null?void 0:s.code,()=>ae(s),"Editar orden de servicio")},{dataField:"business.name",caption:"Empresa",minWidth:210},{dataField:"client.full_name",caption:"Cliente",minWidth:330},{dataField:"expected_document_type",caption:"Tipo comprobante",width:170,minWidth:170},{dataField:"currency",caption:"Moneda",width:105,lookup:Ae(Ss)},{dataField:"created_at",caption:"Fecha registro",dataType:"datetime",width:185,minWidth:185,format:"yyyy-MM-dd HH:mm:ss"},{dataField:"creator.fullname",caption:"Usuario registro",minWidth:185,calculateCellValue:t=>St(t.creator)}],Zt=F?Xt:Qt,es=ie.reduce((t,s)=>t+Number(s.total||0),0),ke=ie.reduce((t,s)=>t+Number(s.total||0),0),xt=Number((ke*.18).toFixed(2)),ts=Number((ke+xt).toFixed(2)),Oe=Dt==="USD"?"$":"S/",Ce=t=>Number(t||0).toFixed(5),ss=j?e.jsxs("div",{className:"service-order-list-panel",children:[e.jsxs("div",{className:"service-order-tabs",children:[e.jsx("button",{type:"button",className:T==="services"?"active":"",onClick:()=>Je("services"),children:"Servicios"}),e.jsx("button",{type:"button",className:T==="deleted"?"active":"",onClick:()=>Je("deleted"),children:"OS Eliminadas"})]}),e.jsxs("div",{className:"service-order-filter-panel",children:[e.jsxs("div",{className:"row g-3 align-items-end",children:[e.jsxs("div",{className:"col-12 col-lg-6",children:[e.jsx("label",{className:"form-label",children:"Cliente"}),e.jsxs("select",{className:"form-select",value:ve,onChange:t=>Ye(t.target.value),children:[e.jsx("option",{value:"",children:T==="deleted"?"Seleccione":"Todos"}),he.map(t=>e.jsxs("option",{value:t.entity_id??t.id,children:[t.document_number?`${t.document_number} - `:"",t.full_name]},`service-order-filter-client-${t.id}`))]})]}),e.jsxs("div",{className:"col-12 col-lg-6",children:[e.jsx("label",{className:"form-label",children:"Fecha Registro (Inicio - Fin):"}),e.jsxs("div",{className:"service-order-date-range",children:[e.jsx("input",{type:"date",className:"form-control",value:je,onChange:t=>Qe(t.target.value)}),e.jsx("input",{type:"date",className:"form-control",value:ye,onChange:t=>Xe(t.target.value)})]})]})]}),e.jsxs("div",{className:"service-order-filter-actions",children:[e.jsxs("button",{type:"button",className:"btn service-order-outline-btn",onClick:Lt,children:[e.jsx("i",{className:"mdi mdi-filter me-1"})," Filtrar"]}),(ve||je||ye||Ze)&&e.jsx("button",{type:"button",className:"btn service-order-muted-btn",onClick:At,children:"Limpiar"})]})]}),T==="services"&&e.jsxs("div",{className:"service-order-list-summary",children:[e.jsxs("div",{children:[e.jsx("span",{children:"Importe Total"}),e.jsxs("strong",{className:"text-success",children:["S/ ",Ce(_e.penTotal)]}),e.jsxs("strong",{className:"text-success",children:["$ ",Ce(_e.usdTotal)]})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Total Facturado"}),e.jsxs("strong",{className:"text-warning",children:["S/ ",Ce(_e.penBilled)]}),e.jsxs("strong",{className:"text-warning",children:["$ ",Ce(_e.usdBilled)]})]})]})]}):i;return e.jsxs(e.Fragment,{children:[j&&e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        ...
        `}),e.jsx("input",{ref:_,hidden:!0}),e.jsx("input",{ref:v,hidden:!0}),e.jsx("input",{ref:D,type:"date",hidden:!0}),e.jsx("input",{ref:J,type:"date",hidden:!0}),e.jsx("input",{ref:Y,type:"date",hidden:!0}),e.jsx("input",{ref:P,hidden:!0}),e.jsx("input",{ref:Q,hidden:!0}),e.jsx("input",{ref:X,type:"number",hidden:!0}),e.jsx("input",{ref:z,hidden:!0}),e.jsx("input",{ref:L,hidden:!0}),e.jsx("input",{ref:Z,type:"number",hidden:!0}),e.jsx("textarea",{ref:A,hidden:!0}),e.jsx("input",{ref:pe,type:"hidden",value:W,readOnly:!0}),e.jsxs("div",{className:"storage-general-order-actions",children:[e.jsxs("button",{type:"submit",className:"btn btn-primary-outline",children:[e.jsx("i",{className:"mdi mdi-plus me-1"})," Guardar"]}),e.jsxs("button",{type:"button",className:"btn btn-muted","data-bs-dismiss":"modal",children:[e.jsx("i",{className:"mdi mdi-close me-1"})," Cerrar"]})]}),e.jsx("h3",{className:"storage-general-order-heading",children:"Orden de servicio N°"}),e.jsxs("div",{className:"row g-4 align-items-end",children:[e.jsxs("div",{className:"col-12 col-md-6 col-xl-2",children:[e.jsx("label",{className:"form-label",children:"Empresa"}),e.jsxs("select",{ref:ee,className:"form-select",value:M,onChange:async t=>{var r;fe(t.target.value);const s=await Se(t.target.value);se((r=s[0])!=null&&r.id?`${s[0].id}`:"")},required:!0,children:[e.jsx("option",{value:"",children:"Seleccione"}),ge.map(t=>e.jsx("option",{value:t.id,children:t.name},`general-order-business-${t.id}`))]})]}),e.jsxs("div",{className:"col-12 col-md-6 col-xl-4",children:[e.jsx("label",{className:"form-label",children:"Cliente"}),e.jsxs("select",{ref:te,className:"form-select",value:re,onChange:t=>be(t.target.value),required:!0,children:[e.jsx("option",{value:"",children:"Seleccione"}),he.map(t=>e.jsxs("option",{value:t.entity_id??t.id,children:[t.document_number?`${t.document_number} | `:"",t.full_name]},`general-order-client-${t.id}`))]})]}),e.jsxs("div",{className:"col-12 col-md-6 col-xl-3",children:[e.jsx("label",{className:"form-label",children:"Tipo documento"}),e.jsxs("select",{ref:B,className:"form-select",required:!0,children:[e.jsx("option",{value:"",children:"Seleccione"}),e.jsx("option",{value:"Factura",children:"Factura"}),e.jsx("option",{value:"Boleta",children:"Boleta"}),e.jsx("option",{value:"Nota de pedido",children:"Nota de pedido"})]})]}),e.jsxs("div",{className:"col-12 col-md-6 col-xl-3",children:[e.jsx("label",{className:"form-label",children:"Moneda"}),e.jsxs("select",{ref:C,className:"form-select",onChange:t=>mt(t.target.value),required:!0,children:[e.jsx("option",{value:"",children:"Seleccione"}),e.jsx("option",{value:"PEN",children:"Soles"}),e.jsx("option",{value:"USD",children:"Dolares"})]})]})]}),e.jsx("div",{className:"mt-4 mb-3",children:e.jsxs("button",{type:"button",className:"btn btn-outline-primary storage-general-insert",onClick:()=>k(t=>[...t,ce()]),children:[e.jsx("i",{className:"mdi mdi-plus-circle me-1"})," Insertar servicio general"]})}),e.jsx("div",{className:"storage-general-lines-wrap",children:e.jsxs("table",{className:"storage-general-lines",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Servicio"}),e.jsx("th",{style:{width:115},children:"Tarifa"}),e.jsx("th",{style:{width:115},children:"Cantidad"}),e.jsx("th",{style:{width:130},children:"Total"}),e.jsx("th",{style:{width:42}})]})}),e.jsx("tbody",{children:ie.map(t=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsxs("select",{className:"form-select",value:t.service_id,onChange:s=>q(t.uid,"service_id",s.target.value),required:!0,children:[e.jsx("option",{value:"",children:"Seleccione servicio"}),xe.map(s=>e.jsx("option",{value:s.id,children:s.name},`general-order-service-${s.id}`))]})}),e.jsx("td",{children:e.jsx("input",{type:"number",step:"0.01",className:"form-control",value:t.unit_price,onChange:s=>q(t.uid,"unit_price",s.target.value)})}),e.jsx("td",{children:e.jsx("input",{type:"number",step:"0.001",min:"0",className:"form-control",value:t.quantity,onChange:s=>q(t.uid,"quantity",s.target.value)})}),e.jsx("td",{children:e.jsx("input",{className:"form-control",value:Number(t.total||0).toFixed(2),disabled:!0})}),e.jsx("td",{children:e.jsx("button",{type:"button",className:"btn btn-outline-danger btn-sm",onClick:()=>k(s=>s.filter(r=>r.uid!==t.uid)),children:e.jsx("i",{className:"mdi mdi-close"})})})]},`general-order-item-${t.uid}`))}),e.jsx("tfoot",{children:e.jsxs("tr",{children:[e.jsx("td",{colSpan:"3",className:"storage-general-total-label",children:"Total"}),e.jsx("td",{children:e.jsx("input",{className:"form-control",value:es.toFixed(2),disabled:!0})}),e.jsx("td",{})]})})]})})]}):e.jsxs(ze,{modalRef:g,title:Et?"Editar orden de servicio":"Registrar orden de servicio",size:"xl",bodyClass:"service-order-form-modal-body",btnCancelText:"Cerrar",btnSubmitText:"Guardar",onSubmit:Te,children:[e.jsx("style",{children:`
