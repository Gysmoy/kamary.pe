var vn=Object.defineProperty;var _n=(t,n,s)=>n in t?vn(t,n,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[n]=s;var Ga=(t,n,s)=>_n(t,typeof n!="symbol"?n+"":n,s);import{C as yn,c as jn,j as a,r as c,S as z,G as Nn}from"./CreateReactScript-BQEmHc8B.js";import{L as Cn,G as wn,M as Rn}from"./esm-XAA1TWCO.js";import{B as $n}from"./Base-BZJCfbcl.js";import{T as Zt}from"./Table-DsvFLxnp.js";import{M as et}from"./Modal-BpHRFSoz.js";import{R as kn}from"./ReactAppend-CmCssPze.js";import{a as Ee,S as Ie}from"./SetSelectValue-CKeZntsZ.js";import{S as Fn}from"./SelectFormGroup-BeLjaap0.js";import{T as Va}from"./TextareaFormGroup-COu0G6AX.js";import{B as Sn}from"./BillingDocumentsRest-WW_N3DRe.js";import{C as ur}from"./CommercialOrdersRest-DArLGxwY.js";import{B as Dn}from"./BasicRest-BJmaHB2C.js";import{R as Tn}from"./ReferralGuidesRest-CIzM-URQ.js";import{o as yt,b as jt}from"./magistralesRecordPdf-C-x5GdgT.js";import{t as Ua,i as za,j as mr,k as qa}from"./statusLabels-DafAwaKR.js";import"./tippy-react.esm-255dCUw_.js";import"./permissionScope-Be8AULz2.js";import"./ubigeoInei-D0FnAslC.js";class En extends Dn{constructor(){super(...arguments);Ga(this,"path","admin/delivery-delay-reasons")}}const B=new ur,te=new Sn,Ya=new En,Wa=new Tn,In=["client_kind","=","regular"],An=[1,2,3,4,5],On=["EFECTIVO [CONTADO]","TRANSFERENCIA [CONTADO]","YAPE [CONTADO]","PLIN [CONTADO]","TARJETA [CONTADO]","TRANSFERENCIA [CREDITO]"],Ha="ecomsur_oms",Nt=[{id:"orders",label:"Pedidos",kind:"orders"},{id:"issued",label:"Facturas Emitidas",kind:"billing"},{id:"cancelled",label:"Facturas Anuladas",kind:"billing"},{id:"credit-notes",label:"Notas de Credito",kind:"billing"},{id:"visitors",label:"Pedidos - Visitadores",kind:"static"},{id:"visitors-legacy",label:"Pedidos - Visitadores Legacy",kind:"static"},{id:"platforms",label:"Plataformas",kind:"static"},{id:"multivende",label:"Pedidos - Multivende",kind:"multivende"}],Ka={visitors:{pageSize:20,exports:["Copiar","Excel"],filters:[{key:"visitor",label:"Visitador",type:"select",options:["ALICIA ASTO ASTO"]},{key:"dateRange",label:"Fecha Registro (Inicio - Fin):",type:"dateRange"}],headers:["ACCIONES","ESTADO","COMPROBANTE","TIPO DOCUMENTO","CLIENTE","TOTAL","TIPO DE PAGO","F.E COMPROBANTE","F.E GUIA","USUARIO","FECHA REGISTRO","USUARIO REGISTRO","CODIGO","EMPRESA"]},"visitors-legacy":{pageSize:20,exports:["Copiar","Excel"],filters:[{key:"visitor",label:"Visitador",type:"select",options:["Todos","ALICIA ASTO ASTO"]},{key:"dateRange",label:"Fecha Registro (Inicio - Fin):",type:"dateRange"}],headers:["ACCIONES","ESTADO","COMPROBANTE","TIPO DOCUMENTO","CLIENTE","TOTAL","TIPO DE PAGO","F.E COMPROBANTE","F.E GUIA","USUARIO","FECHA REGISTRO","USUARIO REGISTRO","CODIGO","EMPRESA"]},platforms:{pageSize:20,exports:["Copiar","Excel"],filters:[{key:"businessId",label:"Empresa",type:"business"},{key:"dateRange",label:"Fecha Registro (Inicio - Fin):",type:"dateRange"}],headers:["ACCIONES","ESTADO","COMPROBANTE","TIPO DOCUMENTO","CLIENTE","TOTAL","TIPO DE PAGO","USUARIO","FECHA REGISTRO","USUARIO REGISTRO","CODIGO","EMPRESA"]}},q=(t,{variant:n,title:s,icon:l,onClick:p})=>{const g=$('<button type="button"></button>').addClass(`btn btn-xs btn-soft-${n} commercial-order-action-btn`).attr("title",s).attr("aria-label",s).append($("<i></i>").addClass(l)).on("click",m=>{m.preventDefault(),m.stopPropagation(),p()});t.append(g)},pr=t=>`commercial-order-status-badge commercial-order-status-${`${t??"empty"}`.trim().toLowerCase().replace(/[^a-z0-9_-]+/g,"-")||"empty"}`,Ct=(t,n,s)=>{t.addClass("commercial-order-status-cell"),kn(t,a.jsx("span",{className:pr(n),children:s(n)}))},tt=()=>({uid:crypto.randomUUID(),article_id:"",article_label:"",article_code:"",article_lot:"",article_name:"",article_unit:"",article_laboratory:"",article_principle:"",presentations:[],presentation_id:"",presentation_units:1,stock_available:0,reserved_quantity:0,price_unit:0,quantity:1,gross_total:0,discount_type:"none",discount_value:0,discount_amount:0,total:0,price_source:"fallback",price_list_code:""}),Pn=t=>{if(!t)return"";const n=(t.name??"").toString().trim().split(" ")[0]??"",s=(t.lastname??"").toString().trim().split(" ")[0]??"",l=`${n} ${s}`.trim(),p=(t.username??"").toString().trim();return l&&p?`${l} (@${p})`:l||(p?`@${p}`:"")},Mn=t=>{if(!t)return"-";const n=(t.fullname??"").toString().trim();return n||`${t.name??""} ${t.lastname??""}`.trim()||(t.username??"").toString().trim()||"-"},ea=t=>t&&((t.username??"").toString().trim()||(t.fullname??"").toString().trim()||`${t.name??""} ${t.lastname??""}`.trim())||"-",at=t=>Number(Number(t||0).toFixed(2)),T=t=>$("<div>").text(t??"").html(),Ae=t=>{const n=Number(Number(t||0).toFixed(3));return Number.isInteger(n)?`${n}`:`${n}`.replace(/\.?0+$/,"")},ia=t=>(t==null?void 0:t.price_source)==="manual",Ja=(t,n,s=!1)=>{const l=Number((t==null?void 0:t.price_unit)||0),p=Number(n==null?void 0:n.price_unit);return!s&&ia(t)||!Number.isFinite(p)||!s&&p<=0&&l>0?l:p},Qa=(t,n,s=!1)=>!s&&ia(t)?"manual":(n==null?void 0:n.source)||(t==null?void 0:t.price_source)||"fallback",Ln=t=>{const n=`${t??""}`.replace(",",".").replace(/[^\d.]/g,"");if(!n)return"";const[s,...l]=n.split("."),p=s.replace(/^0+(?=\d)/,"")||(s||l.length?"0":""),g=l.length?`.${l.join("")}`:"";return`${p}${g}`},Xa=t=>{const n=Ln(t.target.value);return t.target.value!==n&&(t.target.value=n),Number(n||0)},Za=t=>{Number(t.target.value||0)===0&&t.target.select()},Bn=(t,n,s)=>{const l=at(t),p=Number(s||0);return!Number.isFinite(p)||p<=0||l<=0?0:n==="percent"?Math.min(l,at(l*Math.min(p,100)/100)):n==="amount"?Math.min(l,at(p)):0},_e=t=>{const n=Number(t.quantity||0),s=Number(t.price_unit||0),l=Number.isFinite(n*s)?at(n*s):0,p=Bn(l,t.discount_type,t.discount_value);return{...t,discount_type:t.discount_type||"none",discount_value:t.discount_type==="none"?0:Number(t.discount_value||0),gross_total:l,discount_amount:p,total:at(Math.max(0,l-p))}},Ft=t=>{const n=`${t??""}`.trim().toLowerCase();return n==="boleta"?"Boleta":["nota de pedido","nota_pedido","note_order"].includes(n)?"Nota de pedido":"Factura"},Gn=t=>(t==null?void 0:t.billing_documents)??(t==null?void 0:t.billingDocuments)??[],Oe=t=>Gn(t)[0]??null,ye=t=>t&&([t==null?void 0:t.series,t==null?void 0:t.sequence].filter(Boolean).join("-")||(t==null?void 0:t.code))||"",$t=t=>!!(`${(t==null?void 0:t.series)??""}`.trim()&&`${(t==null?void 0:t.sequence)??""}`.trim()),er=t=>{const n=Oe(t);return ye(n)||(t==null?void 0:t.referral_guide)||(t==null?void 0:t.guide_number)||(t==null?void 0:t.purchase_order)||"-"},Vn=t=>{var n,s,l;return((n=t==null?void 0:t.client)==null?void 0:n.full_name)??((s=t==null?void 0:t.eventual_client)==null?void 0:s.business_name)??((l=t==null?void 0:t.eventualClient)==null?void 0:l.business_name)??"-"},Un=t=>{var n,s,l;return((n=t==null?void 0:t.commercial_order)==null?void 0:n.code)??((s=t==null?void 0:t.commercialOrder)==null?void 0:s.code)??((l=t==null?void 0:t.metadata)==null?void 0:l.source_code)??"-"},ta=t=>{var n;return Ft(((n=Oe(t))==null?void 0:n.document_type)??(t==null?void 0:t.document_type))},tr=t=>{const n=(t==null?void 0:t.client)??(t==null?void 0:t.eventual_client)??(t==null?void 0:t.eventualClient)??null,s=`${(n==null?void 0:n.document_number)??""}`.trim(),l=`${(n==null?void 0:n.full_name)??(n==null?void 0:n.business_name)??""}`.trim();return[s,l].filter(Boolean).join(" | ")||"-"},zn=t=>{const n=`${(t==null?void 0:t.payment_method)??""}`.trim(),s=`${(t==null?void 0:t.payment_condition)??""}`.trim();return!n&&!s?"-":!s||n.includes("[")?n||"-":`${n||"-"} [${s.toUpperCase()}]`},ar=t=>{if(!t)return"-";const n=new Date(t);return Number.isNaN(n.getTime())?`${t}`:n.toLocaleString("es-PE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"})},ra=()=>new Date().toISOString().slice(0,10).replaceAll("-","/"),re=()=>{const t=ra();return`${t} - ${t}`},rr=(t,n)=>new Promise((s,l)=>{const p=document.getElementById(t);if(p){p.dataset.loaded==="true"?s():p.addEventListener("load",s,{once:!0});return}const g=document.createElement("script");g.id=t,g.src=n,g.async=!0,g.onload=()=>{g.dataset.loaded="true",s()},g.onerror=l,document.body.appendChild(g)}),qn=(t,n)=>{if(document.getElementById(t))return;const s=document.createElement("link");s.id=t,s.rel="stylesheet",s.href=n,document.head.appendChild(s)},Yn=async()=>{var t,n;qn("commercial-order-daterangepicker-css","/lte-v1/assets/libs/admin-resources/bootstrap-datepicker/css/daterangepicker.css"),window.moment||await rr("commercial-order-moment-js","/lte-v1/assets/libs/admin-resources/bootstrap-datepicker/js/moment.min.js"),(n=(t=window.$)==null?void 0:t.fn)!=null&&n.daterangepicker||await rr("commercial-order-daterangepicker-js","/lte-v1/assets/libs/admin-resources/bootstrap-datepicker/js/daterangepicker.js")},fr=()=>({orders:{businessId:"",dateRange:re(),laboratoryId:"",dispatchStatus:""},issued:{businessId:"",dateRange:re()},cancelled:{businessId:"",dateRange:re()},"credit-notes":{businessId:"",dateRange:re()},visitors:{visitor:"ALICIA ASTO ASTO",dateRange:re()},"visitors-legacy":{visitor:"",dateRange:re()},platforms:{businessId:"",dateRange:re()},multivende:{dateRange:re(),orderVtex:""}}),Wn=()=>{const t=fr();return{...t,orders:{...t.orders,dateRange:""}}},nr=t=>{const n=`${t??""}`.trim();return n?n.replaceAll("/","-").slice(0,10):""},hr=t=>{const[n="",s=""]=`${t??""}`.split(/\s+-\s+/);return{start:nr(n),end:nr(s||n)}},Dt=t=>t.filter(Boolean).reduce((n,s)=>n?[n,"and",s]:s,null),sa=(t,n="created_at")=>{const{start:s,end:l}=hr(t);return Dt([s?[n,">=",`${s} 00:00:00`]:null,l?[n,"<=",`${l} 23:59:59`]:null])},Hn=t=>{const n=["document_type","<>","Nota de credito"];return t==="issued"?[[["local_status","=","sent"],"or",["local_status","=","accepted"],"or",["local_status","=","observed"],"or",["local_status","=","rejected"]],"and",n]:t==="cancelled"?[["local_status","=","cancelled"],"and",n]:t==="credit-notes"?["document_type","=","Nota de credito"]:null},Kn=(t,n)=>Dt([["source_type","=","commercial_order"],Hn(t),n!=null&&n.businessId?["business_id","=",Number(n.businessId)]:null,sa(n==null?void 0:n.dateRange,"created_at")]),Jn=t=>Dt([t!=null&&t.businessId?["business_id","=",Number(t.businessId)]:null,t!=null&&t.dispatchStatus?["dispatch_status","=",t.dispatchStatus]:null,sa(t==null?void 0:t.dateRange,"created_at")]),Qn=(t,n)=>{const s=`${(t==null?void 0:t.orderVtex)??""}`.trim();return Dt([["external_source","=",n],sa(t==null?void 0:t.dateRange,"created_at"),s?[["external_order_id","contains",s],"or",["external_checkout_id","contains",s]]:null])},aa=t=>{const n=(t==null?void 0:t.client)??(t==null?void 0:t.eventualClient)??(t==null?void 0:t.eventual_client)??null,s=`${(n==null?void 0:n.document_number)??""}`.trim(),l=`${(n==null?void 0:n.full_name)??(n==null?void 0:n.business_name)??""}`.trim();return[s,l].filter(Boolean).join(" | ")||"-"},wt=t=>`${t??""}`.toUpperCase()==="USD"?"Dolares":"Soles",ir=t=>(t==null?void 0:t.external_reference)||(t==null?void 0:t.external_id)||(t==null?void 0:t.external_status)||"-",Xn=t=>{var n,s;return((n=t==null?void 0:t.referenceDocument)==null?void 0:n.code)??((s=t==null?void 0:t.reference_document)==null?void 0:s.code)??"-"},Zn=t=>{var n,s;return(t==null?void 0:t.cancel_reason)??((n=t==null?void 0:t.metadata)==null?void 0:n.cancel_reason)??((s=t==null?void 0:t.metadata)==null?void 0:s.reason)??"-"},ei=t=>{var n,s;return((n=Oe(t))==null?void 0:n.external_status)??((s=Oe(t))==null?void 0:s.external_reference)??"-"},ti=t=>(t==null?void 0:t.external_order_id)||(t==null?void 0:t.external_checkout_id)||"-",br=t=>{var p;const n=na(t);if(n!=null&&n.delivered_at)return n.delivered_at;const l=((t==null?void 0:t.dispatchAssignments)??(t==null?void 0:t.dispatch_assignments)??[]).find(g=>{var m;return(m=g==null?void 0:g.dispatch)==null?void 0:m.delivered_at});return((p=l==null?void 0:l.dispatch)==null?void 0:p.delivered_at)??""},ai=t=>{const n=t!=null&&t.created_at?new Date(t.created_at):null,s=br(t)||(t==null?void 0:t.updated_at),l=s?new Date(s):null;if(!n||!l||Number.isNaN(n.getTime())||Number.isNaN(l.getTime()))return"-";const p=Math.max(0,Math.round((l-n)/6e4)),g=Math.floor(p/1440),m=Math.floor(p%1440/60);return g>0?`${g}d ${m}h`:m>0?`${m}h ${p%60}m`:`${p}m`},F=(t,n="")=>{if(t==null)return n;if(typeof t=="object")return t.address??t.reference??t.name??t.description??n;const s=`${t}`;return s==="[object Object]"?n:s},ri=t=>`${t??""}`.toUpperCase().includes("CREDITO")?"Credito":"Contado",ni=t=>{const n=`${t??""}`.trim();return n?n.toUpperCase()==="TRANSFERENCIA"?"TRANSFERENCIA [CONTADO]":n:"EFECTIVO [CONTADO]"},ii=t=>F(t==null?void 0:t.full_address,F(t==null?void 0:t.address,F(t==null?void 0:t.fiscal_address))),si=t=>F(t==null?void 0:t.ubigeo,F(t==null?void 0:t.district_ubigeo,F(t==null?void 0:t.inei_ubigeo))),sr=t=>{const n=`${t??""}`.trim(),s=n.match(/^(client|eventual)-(\d+)$/);return s?s[2]:n},lr=t=>{var m,y,E;if(t.loading)return t.text;const n=t.data??{},s=t.text||n.name||"",l=(m=n.branch)==null?void 0:m.name,p=(E=(y=n.branch)==null?void 0:y.business)==null?void 0:E.name,g=$("<span>").text(s);return l&&g.append($("<small>").addClass("text-muted ms-1").text(`- ${l}`)),p&&g.append($("<small>").addClass("text-muted ms-1").text(`(${p})`)),g},ae=t=>{if(!(t!=null&&t.current))return;const n=$(t.current);n.empty().val(null),n.trigger(n.data("select2")?"change.select2":"change")},li=t=>t.article_id?"Unidad base":"Sin presentacion",ci=(t,n)=>{const s=(t==null?void 0:t.name)||"Presentacion",l=Ae((t==null?void 0:t.units)||1),p=n!=null&&n.article_unit?` ${n.article_unit}`:" unidad(es) base";return`${s} (${l}${p})`},oi=t=>["Factura","Boleta"].includes(Ft(t)),cr=(t,n)=>{const s=Number(t||0);if(!oi(n))return{subtotal:Number(s.toFixed(2)),taxAmount:0,total:Number(s.toFixed(2))};const l=Number((s/1.18).toFixed(2));return{subtotal:l,taxAmount:Number((s-l).toFixed(2)),total:Number(s.toFixed(2))}},di=(t,n="")=>{const s=new Map;return(t??[]).flatMap(l=>{if(!(l!=null&&l.article_id))return[];const p=`${l.article_id}:${l.warehouse_id||n||""}`,g=Number(l.quantity||0),m=Number(l.presentation_units||1)||1,y=Number((g*m).toFixed(3)),E=Number(l.stock_available||0),V=Number(s.get(p)||0),A=Math.max(0,E-V),w=Math.min(y,A),U=Math.max(0,y-w);return s.set(p,V+w),U<=1e-4?[]:[{article:l.article_name||l.article_label||l.article_code||"Articulo",quantity:y,lineQuantity:g,presentationUnits:m,available:A,shortage:U}]})},kt=t=>(t==null?void 0:t.referral_guides)??(t==null?void 0:t.referralGuides)??[],xr=t=>(t==null?void 0:t.external_reference)||[t==null?void 0:t.series,t==null?void 0:t.sequence].filter(Boolean).join("-")||(t==null?void 0:t.code)||"-",ui=t=>t&&!["accepted","cancelled"].includes(t.guide_status),mi=t=>(t==null?void 0:t.delivery_evidences)??(t==null?void 0:t.deliveryEvidences)??[],na=t=>mi(t)[0]??null,pi=t=>(t==null?void 0:t.tracking_events)??(t==null?void 0:t.trackingEvents)??[],or=t=>{const n=`${t??""}`.trim();return n.startsWith("blob:")||n.startsWith("data:image/")||/\.(png|jpe?g|webp|gif|bmp|svg)(\?.*)?$/i.test(n)||n.includes("/delivery-evidence-media/")},dr=()=>{const t=new Date;return t.setMinutes(t.getMinutes()-t.getTimezoneOffset()),t.toISOString().slice(0,16)},Rt={lat:-12.046374,lng:-77.042793},ne=t=>{const n=Number(t);return Number.isFinite(n)?n:null},St=t=>{const n=ne(t);return n===null?"":n.toFixed(7)},ie=t=>ne(t==null?void 0:t.lat)!==null&&ne(t==null?void 0:t.lng)!==null,fi=({modalRef:t,position:n,searchText:s,onPositionChange:l,onSearchTextChange:p,onAddressSelected:g,googleMapsApiKey:m})=>{const y=c.useRef(),[E,V]=c.useState(!1),[A,w]=c.useState(""),[U,se]=c.useState([]),Z=ie(n)?{lat:ne(n.lat),lng:ne(n.lng)}:Rt,O=(h,k=17)=>{const Y=ne(h==null?void 0:h.lat),W=ne(h==null?void 0:h.lng);Y===null||W===null||!y.current||(y.current.setCenter({lat:Y,lng:W}),y.current.setZoom(k))},he=h=>{l(h),O(h)};c.useEffect(()=>{if(ie(n)){O(Z);return}O(Rt,13)},[n==null?void 0:n.lat,n==null?void 0:n.lng]),c.useEffect(()=>{const h=t==null?void 0:t.current;if(!h)return;const k=()=>{setTimeout(()=>{ie(n)?O(Z):O(Rt,13)},180)};return $(h).on("shown.bs.modal",k),()=>$(h).off("shown.bs.modal",k)},[t,n==null?void 0:n.lat,n==null?void 0:n.lng]);const je=async()=>{var k,Y;const h=`${s??""}`.trim();if(!h){se([]),w("Escribe una direccion para buscar.");return}if(!((Y=(k=window.google)==null?void 0:k.maps)!=null&&Y.Geocoder)){w("Google Maps aun no termino de cargar.");return}V(!0),w("");try{new window.google.maps.Geocoder().geocode({address:`${h}, Peru`,componentRestrictions:{country:"PE"},region:"PE"},(le,Ne)=>{if(V(!1),Ne!=="OK"||!Array.isArray(le)||le.length===0){se([]),w("Sin resultados. Puedes marcar el punto manualmente en el mapa.");return}se(le.slice(0,5).map(G=>({place_id:G.place_id,display_name:G.formatted_address,lat:G.geometry.location.lat(),lng:G.geometry.location.lng()})))})}catch(W){V(!1),w(`${W.message}. Puedes marcar el punto manualmente en el mapa.`),se([])}},Pe=h=>{const k={lat:ne(h.lat),lng:ne(h.lng)};l(k),p(h.display_name??""),g(h.display_name??""),O(k),se([])};return a.jsxs("div",{className:"commercial-order-map-picker",children:[a.jsxs("div",{className:"commercial-order-map-search",children:[a.jsxs("div",{children:[a.jsx("label",{className:"form-label",children:"Buscar direccion en mapa"}),a.jsxs("div",{className:"input-group",children:[a.jsx("input",{type:"text",className:"form-control",value:s,onChange:h=>p(h.target.value),onKeyDown:h=>{h.key==="Enter"&&(h.preventDefault(),je())},placeholder:"Ej. Av. Javier Prado 123, San Isidro"}),a.jsx("button",{type:"button",className:"btn btn-outline-primary",onClick:je,disabled:E,children:E?"Buscando...":"Buscar"})]})]}),a.jsxs("div",{className:"commercial-order-map-coordinates",children:[a.jsx("label",{className:"form-label",children:"Coordenadas"}),a.jsxs("div",{className:"commercial-order-map-coordinate-values",children:[a.jsx("span",{children:St(n==null?void 0:n.lat)||"-"}),a.jsx("span",{children:St(n==null?void 0:n.lng)||"-"})]})]})]}),U.length>0&&a.jsx("div",{className:"commercial-order-map-results",children:U.map(h=>a.jsx("button",{type:"button",className:"commercial-order-map-result",onClick:()=>Pe(h),children:h.display_name},`${h.place_id}-${h.lat}-${h.lng}`))}),A&&a.jsx("small",{className:"text-muted d-block mt-1",children:A}),a.jsx(Cn,{googleMapsApiKey:m,language:"es",region:"PE",onError:()=>w("No se pudo cargar Google Maps. Revisa la API key y las restricciones de dominio."),children:a.jsx(wn,{mapContainerClassName:"commercial-order-map-canvas",center:Z,zoom:ie(n)?17:13,options:{clickableIcons:!0,fullscreenControl:!0,gestureHandling:"greedy",mapTypeControl:!0,scrollwheel:!0,streetViewControl:!1},onLoad:h=>{y.current=h,setTimeout(()=>{ie(n)?O(Z):O(Rt,13)},120)},onClick:h=>{const k={lat:h.latLng.lat(),lng:h.latLng.lng()};he(k)},children:ie(n)&&a.jsx(Rn,{position:Z,draggable:!0,onDragEnd:h=>he({lat:h.latLng.lat(),lng:h.latLng.lng()})})})}),a.jsx("small",{className:"text-muted d-block mt-2",children:"Haz clic en el mapa o arrastra el marcador para fijar la ubicacion de entrega."})]})},hi=t=>{const n=`${Nn.GMAPS_API_KEY??""}`.trim();return n?a.jsx(fi,{...t,googleMapsApiKey:n}):a.jsx("div",{className:"commercial-order-map-picker",children:a.jsx("div",{className:"commercial-order-map-empty",children:"Configura Google Maps API Key en Sistemas > Datos generales > Integraciones para habilitar el mapa."})})},bi=t=>!t||t.status===null||`${t.order_status??""}`=="cancelled"?!1:`${t.dispatch_status??"pending"}`=="pending",xi=t=>!t||t.status===null||t.status===!1||t.status===0?!1:!["draft","cancelled"].includes(`${t.order_status??""}`),gr=t=>{if(!t)return!1;const n=`${t.local_status??""}`;return["accepted","observed","cancelled"].includes(n)||!!t.external_id},gi=t=>{const n=Oe(t);return n?gr(n)?{icon:"mdi mdi-file-document-check-outline",title:`Descargar PDF del comprobante ${ye(n)||n.code}`}:$t(n)?{icon:"mdi mdi-printer",title:`Emitir o imprimir comprobante ${ye(n)||n.code}`}:{icon:"mdi mdi-send",title:`Emitir comprobante ${ye(n)||n.code}`}:{icon:"mdi mdi-file-send-outline",title:"Generar comprobante de venta para este pedido"}},vi=t=>{if(!t)return[];const n=pi(t).map(m=>({date:m.happened_at??m.created_at,status:[m.title,m.description].filter(Boolean).join(" - ")})),s=[{date:t.created_at,status:"La orden ingreso en el sistema"}];t.approved_at&&["preparing","in_route","delivered","dispatched","billed","closed"].includes(t.order_status)?s.push({date:t.approved_at,status:"La orden paso a preparacion"}):t.approved_at&&t.order_status==="confirmed"?s.push({date:t.approved_at,status:"La orden fue confirmada"}):["preparing","in_route","delivered","dispatched","billed","closed"].includes(t.order_status)&&s.push({date:t.updated_at,status:"La orden paso a preparacion"});const l=(t.dispatch_assignments??t.dispatchAssignments??[]).filter(m=>(m==null?void 0:m.status)!==!1&&(m==null?void 0:m.status)!==0&&(m==null?void 0:m.dispatch)).sort((m,y)=>{var E,V,A,w;return new Date(((E=m==null?void 0:m.dispatch)==null?void 0:E.departed_at)||((V=m==null?void 0:m.dispatch)==null?void 0:V.scheduled_date)||0)-new Date(((A=y==null?void 0:y.dispatch)==null?void 0:A.departed_at)||((w=y==null?void 0:y.dispatch)==null?void 0:w.scheduled_date)||0)}),p=l.find(m=>{var y;return["in_route","delivered","closed"].includes((y=m==null?void 0:m.dispatch)==null?void 0:y.dispatch_status)});p?(s.push({date:p.dispatch.departed_at??p.dispatch.updated_at??p.dispatch.created_at,status:`Manifiesto ${p.dispatch.manifest_code||p.dispatch.code||""}`.trim()}),s.push({date:p.dispatch.departed_at??p.dispatch.updated_at??p.dispatch.created_at,status:"El pedido salio en ruta"})):t.dispatch_status==="in_route"&&s.push({date:t.updated_at,status:"El pedido salio en ruta"}),(t.dispatch_status==="dispatched"||l.some(m=>{var y;return((y=m==null?void 0:m.dispatch)==null?void 0:y.dispatch_status)==="dispatched"}))&&s.push({date:t.updated_at,status:"El pedido paso a despacho"}),kt(t).forEach(m=>{s.push({date:m.issue_date??m.created_at??t.updated_at,status:`Guia de remision ${xr(m)} - ${mr(m.guide_status)}`})});const g=l.find(m=>{var y;return["delivered","closed"].includes((y=m==null?void 0:m.dispatch)==null?void 0:y.dispatch_status)});return g?s.push({date:g.dispatch.delivered_at??g.dispatch.updated_at??g.dispatch.created_at,status:"El pedido fue entregado"}):t.dispatch_status==="delivered"&&s.push({date:t.updated_at,status:"El pedido fue entregado"}),(t.order_status==="cancelled"||t.dispatch_status==="cancelled")&&s.push({date:t.updated_at,status:"El pedido fue cancelado"}),[...n,...s].filter(m=>m.date).sort((m,y)=>new Date(m.date)-new Date(y.date))},_i=({title:t,config:n})=>{const s=(n==null?void 0:n.pageSize)??20;return a.jsx("div",{className:"row",children:a.jsx("div",{className:"col-12",children:a.jsxs("div",{className:"card",children:[a.jsx("div",{className:"card-header",children:t}),a.jsxs("div",{className:"card-body",children:[a.jsxs("div",{className:"d-flex flex-wrap align-items-center justify-content-between gap-2 mb-2",children:[a.jsxs("div",{className:"d-flex align-items-center gap-2",children:[a.jsx("label",{className:"form-label mb-0",children:"Elementos :"}),a.jsx("select",{className:"form-select form-select-sm commercial-order-page-size",defaultValue:s,children:[10,20,25,50].map(l=>a.jsx("option",{value:l,children:l},`commercial-list-size-${l}`))})]}),a.jsxs("div",{className:"d-flex align-items-center gap-2",children:[a.jsx("label",{className:"form-label mb-0",children:"Filtrar :"}),a.jsx("input",{className:"form-control form-control-sm commercial-order-list-search"})]})]}),((n==null?void 0:n.exports)??[]).length>0&&a.jsx("div",{className:"d-flex flex-wrap gap-1 mb-2",children:n.exports.map(l=>a.jsx("button",{type:"button",className:"btn btn-sm btn-light",children:l},`commercial-list-export-${l}`))}),a.jsx("div",{className:"table-responsive commercial-order-legacy-table",children:a.jsxs("table",{className:"table table-sm table-bordered table-striped align-middle mb-0",children:[a.jsx("thead",{children:a.jsx("tr",{children:((n==null?void 0:n.headers)??[]).map(l=>a.jsx("th",{children:l},`commercial-list-header-${l}`))})}),a.jsx("tbody",{children:a.jsx("tr",{children:a.jsx("td",{colSpan:((n==null?void 0:n.headers)??[]).length||1,className:"text-muted",children:"No existen elementos"})})})]})}),a.jsxs("div",{className:"d-flex flex-wrap align-items-center justify-content-between gap-2 mt-2",children:[a.jsx("span",{className:"text-muted",children:"No hay elementos a mostrar"}),a.jsxs("div",{className:"d-flex align-items-center gap-2 text-muted",children:[a.jsx("span",{children:"Anterior"}),a.jsx("button",{type:"button",className:"btn btn-sm btn-light active",children:"1"}),a.jsx("span",{children:"Siguiente"})]})]})]})]})})})},yi=({requiredPermission:t="orders",externalSource:n=null,pageTitle:s="Pedidos comerciales"})=>{var Oa;B.externalSource=null;const l=c.useRef(),p=c.useRef(),g=c.useRef(),m=c.useRef(),y=c.useRef(),E=c.useRef(),V=c.useRef(),A=c.useRef(),w=c.useRef(),U=c.useRef(),se=c.useRef(),Z=c.useRef(),O=c.useRef(),he=c.useRef(),je=c.useRef(),Pe=c.useRef(),h=c.useRef(),k=c.useRef(),Y=c.useRef(),W=c.useRef(),le=c.useRef(),Ne=c.useRef(),G=c.useRef(),rt=c.useRef(),vr=c.useRef(),nt=c.useRef(),it=c.useRef(),Me=c.useRef(),st=c.useRef(),lt=c.useRef(),ct=c.useRef(),ot=c.useRef(),dt=c.useRef(),ut=c.useRef(),mt=c.useRef(),pt=c.useRef(),_r=c.useRef(),H=c.useRef(),Ce=c.useRef(),ce=c.useRef(),we=c.useRef(),Re=c.useRef(),ft=c.useRef(),Tt=c.useRef({}),[yr,jr]=c.useState(!1),[$e,la]=c.useState(""),[K,ht]=c.useState(""),[J,bt]=c.useState(""),[ke,Et]=c.useState(""),[Fe,It]=c.useState(""),[Q,Le]=c.useState(""),[Nr,be]=c.useState(""),[At,Ot]=c.useState({lat:"",lng:""}),[Cr,xt]=c.useState(""),[wr,ca]=c.useState([]),[Be,gt]=c.useState([]),[ji,Se]=c.useState([]),[ee,X]=c.useState([tt()]),[Ge,oa]=c.useState("Factura"),[oe,Pt]=c.useState(null),[da,Rr]=c.useState(null),[De,$r]=c.useState(null),[ua,Mt]=c.useState(null),[xe,Lt]=c.useState(""),[Bt,kr]=c.useState([]),[Gt,ma]=c.useState(""),[Vt,pa]=c.useState(!1),[C,Fr]=c.useState(n?"multivende":"orders"),[Sr,Dr]=c.useState([]),[Tr,Er]=c.useState([]),[fa,Ir]=c.useState(fr()),[Ve,Ar]=c.useState(Wn()),[R,Ut]=c.useState({recipient_name:"",recipient_document_type:"DNI",recipient_document_number:"",recipient_phone:"",delivered_at:dr(),evidence_notes:"",evidence_url:"",latitude:"",longitude:""}),Or=c.useMemo(()=>{const e=new ur;return e.externalSource=n||Ha,e},[n]),vt=Nt.find(e=>e.id===C)??Nt[0],Ue=fa[C]??{},ha=Ve[C]??{},Pr=c.useMemo(()=>Jn(Ve.orders),[Ve.orders]),Mr=c.useMemo(()=>Kn(C,ha),[C,ha]),Lr=c.useMemo(()=>Qn(Ve.multivende,n||Ha),[Ve.multivende,n]),Br=c.useMemo(()=>{var r;const e=new URLSearchParams;return $e&&e.append("business_id",$e),K&&e.append("business_branch_id",K),J&&e.append("warehouse_id",J),ke&&e.append("client_id",ke),Fe&&e.append("eventual_client_id",Fe),Q&&e.append("client_distribution_network_id",Q),(r=G.current)!=null&&r.value&&e.append("issue_date",G.current.value),`/api/admin/commercial-orders/articles?${e.toString()}`},[$e,K,J,ke,Fe,Q]),Gr=c.useMemo(()=>K?["business_branch_id","=",Number(K)]:null,[K]);c.useEffect(()=>()=>{xe!=null&&xe.startsWith("blob:")&&URL.revokeObjectURL(xe)},[xe]),c.useEffect(()=>{let e=!0;return Promise.all([te.getBusinesses(),B.getLaboratories()]).then(([r,i])=>{e&&(Dr(r),Er(i))}),()=>{e=!1}},[]),c.useEffect(()=>{if(!oe)return;const e=()=>Pt(null),r=i=>{i.key==="Escape"&&e()};return document.addEventListener("click",e),document.addEventListener("keydown",r),window.addEventListener("resize",e),window.addEventListener("scroll",e,!0),()=>{document.removeEventListener("click",e),document.removeEventListener("keydown",r),window.removeEventListener("resize",e),window.removeEventListener("scroll",e,!0)}},[oe]);const ba=e=>(Tt.current[e]||(Tt.current[e]=c.createRef()),Tt.current[e]);c.useEffect(()=>{ee.forEach(e=>{const r=ba(e.uid);!r.current||!e.article_id||!e.article_label||`${$(r.current).val()}`==`${e.article_id}`||Ee(r.current,e.article_id,e.article_label)})},[ee]);const xa=async(e,r=null)=>{if(!e){ca([]),ht("");return}const o=(await B.getBranchesByBusiness(e)??[]).filter(u=>u.status!==null);if(ca(o),r&&o.some(u=>`${u.id}`==`${r}`)){ht(`${r}`);return}ht("")},ga=e=>{if(!e)return;const r=ii(e),i=si(e);r&&H.current&&(H.current.value=r),i&&ce.current&&(ce.current.value=i),r&&xt(r)},va=async(e,r=null,i=null)=>{var v;if(!e){gt([]),Le(""),Se([]),be("");return}const u=(await B.getDistributionNetworks(e)??[]).filter(f=>f.status!==null);gt(u);const d=r||((v=u.find(f=>f.is_default))==null?void 0:v.id);if(d&&u.some(f=>`${f.id}`==`${d}`)){Le(`${d}`),await _a(d,null,u);return}Le(""),Se([]),be(""),ga(i)},_a=async(e,r=null,i=null)=>{var f,j;if(!e){Se([]),be("");return}let o=[];const u=(i??Be).find(_=>`${_.id}`==`${e}`);(((f=u==null?void 0:u.addresses)==null?void 0:f.length)??0)>0?o=u.addresses:o=await B.getDeliveryAddresses(e);const d=(o??[]).filter(_=>_.status!==null);Se(d);const v=r||((j=d.find(_=>_.is_default))==null?void 0:j.id);if(v&&d.some(_=>`${_.id}`==`${v}`)){be(`${v}`),Vr(d.find(_=>`${_.id}`==`${v}`));return}be("")},Vr=e=>{e&&(H.current&&(H.current.value=F(e.address)),Ce.current&&(Ce.current.value=F(e.reference)),ce.current&&(ce.current.value=F(e.ubigeo)),we.current&&(we.current.value=F(e.contact_name)),Re.current&&(Re.current.value=F(e.contact_phone)),xt(F(e.address)),ie({lat:e.latitude,lng:e.longitude})&&Ot({lat:Number(e.latitude),lng:Number(e.longitude)}))},ya=async(e,r={})=>{var d,v,f;const i=r.article_id??e.article_id,o=Number(r.quantity??e.quantity??0),u=r.presentation_id??e.presentation_id;return!i||!J||o<=0?null:await B.resolvePrice({article_id:i,presentation_id:u||null,quantity:o,business_id:$e||null,business_branch_id:K||null,warehouse_id:J||null,client_id:ke||null,eventual_client_id:Fe||null,client_distribution_network_id:Q||null,issue_date:((d=G.current)==null?void 0:d.value)||null,commercial_channel:((v=Be.find(j=>`${j.id}`==`${Q}`))==null?void 0:v.commercial_channel)||null,segment:((f=Be.find(j=>`${j.id}`==`${Q}`))==null?void 0:f.segment)||null})},zt=async(e=null)=>{const r=e??ee;for(const i of r){if(!i.article_id)continue;const o=await ya(i);o&&X(u=>u.map(d=>d.uid!==i.uid?d:_e({...d,stock_available:Number(o.stock_available||0),price_unit:Ja(d,o),price_source:Qa(d,o),price_list_code:o.price_list_code||""})))}},ja=e=>{e==="regular"?(It(""),ae(W)):e==="eventual"&&(Et(""),gt([]),Le(""),Se([]),be(""),ae(Y))},qt=async(e=null)=>{var f,j,_,S;jr(!!(e!=null&&e.id)),he.current&&(he.current.value=(e==null?void 0:e.id)??""),je.current&&(je.current.value=(e==null?void 0:e.code)??"Se genera al guardar"),G.current&&(G.current.value=e!=null&&e.issue_date?e.issue_date.toString().slice(0,10):new Date().toISOString().slice(0,10)),rt.current&&(rt.current.value=e!=null&&e.promised_delivery_at?e.promised_delivery_at.toString().slice(0,10):""),oa(Ft((e==null?void 0:e.document_type)??"Factura")),nt.current&&(nt.current.value=(e==null?void 0:e.currency)??"PEN"),it.current&&(it.current.value=(e==null?void 0:e.payment_condition)??"Contado"),Me.current&&(Me.current.value=ni(e==null?void 0:e.payment_method)),ot.current&&(ot.current.value=(e==null?void 0:e.installments)??1),dt.current&&(dt.current.value=e!=null&&e.first_due_date?e.first_due_date.toString().slice(0,10):""),ut.current&&(ut.current.value=(e==null?void 0:e.order_status)??(e!=null&&e.external_source?"pending":"draft")),mt.current&&(mt.current.value=(e==null?void 0:e.dispatch_status)??"pending"),pt.current&&(pt.current.value=(e==null?void 0:e.billing_status)??"pending"),H.current&&(H.current.value=F(e==null?void 0:e.delivery_address)),Ce.current&&(Ce.current.value=F(e==null?void 0:e.delivery_reference)),ce.current&&(ce.current.value=F(e==null?void 0:e.ubigeo)),we.current&&(we.current.value=F(e==null?void 0:e.dispatch_contact_name)),Re.current&&(Re.current.value=F(e==null?void 0:e.dispatch_contact_phone)),st.current&&(st.current.value=(e==null?void 0:e.purchase_order)??""),lt.current&&(lt.current.value=(e==null?void 0:e.guide_number)??""),ct.current&&(ct.current.value=(e==null?void 0:e.referral_guide)??""),Ne.current&&(Ne.current.value=(e==null?void 0:e.doctor_name)??""),ft.current&&(ft.current.value=(e==null?void 0:e.observations)??""),Ot({lat:ie({lat:e==null?void 0:e.map_lat,lng:e==null?void 0:e.map_lng})?Number(e.map_lat):"",lng:ie({lat:e==null?void 0:e.map_lat,lng:e==null?void 0:e.map_lng})?Number(e.map_lng):""}),xt(F(e==null?void 0:e.delivery_address));const r=e!=null&&e.business_id?`${e.business_id}`:"",i=e!=null&&e.warehouse_id?`${e.warehouse_id}`:"",o=e!=null&&e.client_id?`${e.client_id}`:"",u=e!=null&&e.eventual_client_id?`${e.eventual_client_id}`:"";la(r),bt(i),Et(o),It(u),r&&((f=e==null?void 0:e.business)!=null&&f.name)?Ee(Pe.current,r,e.business.name):ae(Pe),i&&((j=e==null?void 0:e.warehouse)!=null&&j.name)?Ee(k.current,i,e.warehouse.name):ae(k),o&&((_=e==null?void 0:e.client)!=null&&_.full_name)?Ee(Y.current,o,`${e.client.document_number??""} - ${e.client.full_name}`.trim()):ae(Y),u&&((S=e==null?void 0:e.eventual_client)!=null&&S.business_name)?Ee(W.current,u,`${e.eventual_client.document_number??""} - ${e.eventual_client.business_name}`.trim()):ae(W),e!=null&&e.seller_id&&(e!=null&&e.seller)?Ee(le.current,e.seller_id,Pn(e.seller)):ae(le);const d=((e==null?void 0:e.items)??[]).map(x=>{var ue,me,pe,fe,N,D,ze,qe,Ye,We,He,Ke,Je,Qe,Xe,Ze;const b=x.article??null,P=((b==null?void 0:b.presentations)??[]).filter(M=>(M==null?void 0:M.status)!==!1&&(M==null?void 0:M.status)!==0),I=x.presentation??P[0]??null,ve=Number(x.presentation_units??(I==null?void 0:I.units)??1)||1;return _e({uid:crypto.randomUUID(),article_id:x.article_id?`${x.article_id}`:"",article_label:b?`${b.code??""} - ${b.name??""}`.trim():"",article_code:(b==null?void 0:b.code)??x.external_sku??"",article_lot:(b==null?void 0:b.default_lot)??"",article_name:(b==null?void 0:b.name)??"",article_unit:((ue=b==null?void 0:b.unit)==null?void 0:ue.symbol)??((me=b==null?void 0:b.unit)==null?void 0:me.name)??"",article_laboratory:((pe=b==null?void 0:b.laboratory)==null?void 0:pe.name)??"",article_principle:((fe=b==null?void 0:b.activePrinciple)==null?void 0:fe.name)??((N=b==null?void 0:b.active_principle)==null?void 0:N.name)??"",presentations:P.map(M=>({id:`${M.id}`,name:M.name??"Presentacion",units:Number(M.units||1),price:Number(M.price||0)})),presentation_id:I!=null&&I.id?`${I.id}`:"",presentation_units:ve,stock_available:Number(x.stock_available||0),reserved_quantity:Number(x.reserved_quantity||0),price_unit:Number(x.price_unit||0),quantity:Number(x.quantity||1),discount_type:((ze=(D=x.external_payload)==null?void 0:D.commercial_form)==null?void 0:ze.discount_type)??"none",discount_value:Number(((Ye=(qe=x.external_payload)==null?void 0:qe.commercial_form)==null?void 0:Ye.discount_value)||0),discount_amount:Number(((He=(We=x.external_payload)==null?void 0:We.commercial_form)==null?void 0:He.discount_amount)||0),gross_total:Number(((Je=(Ke=x.external_payload)==null?void 0:Ke.commercial_form)==null?void 0:Je.gross_total)||0),total:Number(x.total||0),price_source:x.price_source||"fallback",price_list_code:((Xe=(Qe=x==null?void 0:x.price_list_item)==null?void 0:Qe.price_list)==null?void 0:Xe.code)||((Ze=e==null?void 0:e.price_list)==null?void 0:Ze.code)||""})}),v=d.length?d:[tt()];X(v),$(m.current).modal("show"),await xa((e==null?void 0:e.business_id)??null,(e==null?void 0:e.business_branch_id)??null),o?(await va(o,(e==null?void 0:e.client_distribution_network_id)??null),e!=null&&e.client_distribution_network_id&&await _a(e.client_distribution_network_id,(e==null?void 0:e.client_delivery_address_id)??null)):(gt([]),Le(""),Se([]),be(""))},Ur=async e=>{var u,d,v,f,j,_,S,x,b,P,I,ve,ue,me,pe,fe,N,D,ze,qe,Ye,We,He,Ke,Je,Qe,Xe,Ze,M,Pa,Ma,La,Ba;e.preventDefault();const r={id:((u=he.current)==null?void 0:u.value)||void 0,external_source:n||void 0,business_id:$e||null,business_branch_id:K||null,warehouse_id:J||null,client_id:ke||null,eventual_client_id:Fe||null,seller_id:((d=le.current)==null?void 0:d.value)||null,client_distribution_network_id:Q||null,client_delivery_address_id:Nr||null,document_type:Ge,currency:((v=nt.current)==null?void 0:v.value)||"PEN",payment_condition:ri(((f=Me.current)==null?void 0:f.value)||((j=it.current)==null?void 0:j.value)||"Contado"),payment_method:((_=Me.current)==null?void 0:_.value)||"",purchase_order:((x=(S=st.current)==null?void 0:S.value)==null?void 0:x.trim())||"",guide_number:((P=(b=lt.current)==null?void 0:b.value)==null?void 0:P.trim())||"",referral_guide:((ve=(I=ct.current)==null?void 0:I.value)==null?void 0:ve.trim())||"",doctor_name:((me=(ue=Ne.current)==null?void 0:ue.value)==null?void 0:me.trim())||"",issue_date:((pe=G.current)==null?void 0:pe.value)||"",promised_delivery_at:((fe=rt.current)==null?void 0:fe.value)||null,installments:((N=ot.current)==null?void 0:N.value)||1,first_due_date:((D=dt.current)==null?void 0:D.value)||null,order_status:((ze=ut.current)==null?void 0:ze.value)||(n?"pending":"draft"),dispatch_status:((qe=mt.current)==null?void 0:qe.value)||"pending",billing_status:((Ye=pt.current)==null?void 0:Ye.value)||"pending",tax_amount:Ht.taxAmount,delivery_address:((He=(We=H.current)==null?void 0:We.value)==null?void 0:He.trim())||"",delivery_reference:((Je=(Ke=Ce.current)==null?void 0:Ke.value)==null?void 0:Je.trim())||"",ubigeo:((Xe=(Qe=ce.current)==null?void 0:Qe.value)==null?void 0:Xe.trim())||"",map_lat:St(At.lat)||null,map_lng:St(At.lng)||null,dispatch_contact_name:((M=(Ze=we.current)==null?void 0:Ze.value)==null?void 0:M.trim())||"",dispatch_contact_phone:((Ma=(Pa=Re.current)==null?void 0:Pa.value)==null?void 0:Ma.trim())||"",observations:((Ba=(La=ft.current)==null?void 0:La.value)==null?void 0:Ba.trim())||"",items:ee.map(L=>({article_id:L.article_id||null,presentation_id:L.presentation_id||null,warehouse_id:J||null,stock_available:L.stock_available,reserved_quantity:L.reserved_quantity,presentation_units:L.presentation_units,price_unit:L.price_unit,quantity:L.quantity,gross_total:L.gross_total,discount_type:L.discount_type,discount_value:L.discount_value,discount_amount:L.discount_amount,total:L.total,status:!0}))},i=di(ee,J);if(i.length>0){const L=`
      ...
      `,{isConfirmed:gn}=await z.fire({title:"Stock insuficiente",html:L,icon:"warning",showCancelButton:!0,confirmButtonText:"Crear de todas formas",cancelButtonText:"Revisar pedido"});if(!gn)return;r.allow_stock_shortage=!0}await B.save(r)&&($(l.current).dxDataGrid("instance").refresh(),$(m.current).modal("hide"))},zr=async e=>{const r=e.target.value||"";la(r),bt(""),ae(k),await xa(r,null)},qr=e=>{const r=e.target.value||"";ht(r),bt(""),ae(k)},Yr=async e=>{const r=e.target.value||"";bt(r),await zt()},Wr=async e=>{var o,u;const r=sr(e.target.value),i=((u=(o=$(e.target).select2("data"))==null?void 0:o[0])==null?void 0:u.data)??null;Et(r),ja("regular"),ga(i),await va(r,null,i),await zt()},Hr=async e=>{const r=sr(e.target.value);It(r),ja("eventual"),await zt()},ge=(e,r,i)=>{Ir(o=>({...o,[e]:{...o[e]??{},[r]:i}}))},Na=(e=C)=>{var i;const r=e==="multivende"?g:((i=Nt.find(o=>o.id===e))==null?void 0:i.kind)==="billing"?p:l;return r.current?$(r.current).dxDataGrid("instance"):null},Ca=(e=C)=>{const r=Na(e);r&&r.refresh()},wa=(e=C)=>{const r=fa[e]??{};e==="orders"&&B.setFilters({laboratory_id:r.laboratoryId||""}),Ar(i=>({...i,[e]:r})),setTimeout(()=>Ca(e),0)},Kr=e=>{var r;(r=e==null?void 0:e.preventDefault)==null||r.call(e),wa(C)},Ra=(e=!1)=>{const r=C;e&&wa(r),setTimeout(()=>{const i=Na(r);i!=null&&i.exportToExcel&&i.exportToExcel(!1)},e?350:0)},Jr=async({id:e,field:r,value:i})=>{await B.boolean({id:e,field:r,value:i})&&$(l.current).dxDataGrid("instance").refresh()},$a=e=>{Rr(e),$(se.current).modal("show")},Qr=e=>{const r=na(e);$r(e),Mt(null),Lt(or(r==null?void 0:r.evidence_url)?r.evidence_url:""),Ut({recipient_name:(r==null?void 0:r.recipient_name)??(e==null?void 0:e.dispatch_contact_name)??"",recipient_document_type:(r==null?void 0:r.recipient_document_type)??"DNI",recipient_document_number:(r==null?void 0:r.recipient_document_number)??"",recipient_phone:(r==null?void 0:r.recipient_phone)??(e==null?void 0:e.dispatch_contact_phone)??"",delivered_at:r!=null&&r.delivered_at?`${r.delivered_at}`.replace(" ","T").slice(0,16):dr(),evidence_notes:(r==null?void 0:r.evidence_notes)??"",evidence_url:(r==null?void 0:r.evidence_url)??"",latitude:(r==null?void 0:r.latitude)??"",longitude:(r==null?void 0:r.longitude)??""}),navigator.geolocation&&navigator.geolocation.getCurrentPosition(i=>{Ut(o=>({...o,latitude:o.latitude||i.coords.latitude,longitude:o.longitude||i.coords.longitude}))},()=>{},{enableHighAccuracy:!0,timeout:5e3}),setTimeout(()=>{O.current&&(O.current.value="")},0),$(Z.current).modal("show")},Xr=e=>{var i;const r=((i=e.target.files)==null?void 0:i[0])??null;Mt(r),Lt(r?URL.createObjectURL(r):or(R.evidence_url)?R.evidence_url:"")},de=(e,r)=>Ut(i=>({...i,[e]:r})),Zr=async e=>{if(e.preventDefault(),!(De!=null&&De.id))return;const r=(De.dispatch_assignments??De.dispatchAssignments??[]).filter(u=>(u==null?void 0:u.status)!==!1&&(u==null?void 0:u.status)!==0&&(u==null?void 0:u.dispatch)).sort((u,d)=>{var v,f;return new Date(((v=d==null?void 0:d.dispatch)==null?void 0:v.scheduled_date)||(d==null?void 0:d.created_at)||0)-new Date(((f=u==null?void 0:u.dispatch)==null?void 0:f.scheduled_date)||(u==null?void 0:u.created_at)||0)})[0],i=new FormData;r!=null&&r.dispatch_id&&i.append("dispatch_id",r.dispatch_id),i.append("recipient_name",R.recipient_name??""),i.append("recipient_document_type",R.recipient_document_type??"DNI"),i.append("recipient_document_number",R.recipient_document_number??""),i.append("recipient_phone",R.recipient_phone??""),i.append("delivered_at",R.delivered_at??""),i.append("evidence_notes",R.evidence_notes??""),i.append("evidence_url",R.evidence_url??""),i.append("latitude",R.latitude??""),i.append("longitude",R.longitude??""),ua&&i.append("evidence_file",ua),await B.saveDeliveryEvidence(De.id,i)&&(Mt(null),Lt(""),O.current&&(O.current.value=""),$(Z.current).modal("hide"),$(l.current).dxDataGrid("instance").refresh())},ka=async e=>{const r=kt(e)[0];if(r){if(ui(r)){const o=await z.fire({title:"Guia de remision",text:`La guia ${xr(r)} esta ${mr(r.guide_status).toLowerCase()}.`,icon:"question",showCancelButton:!0,showDenyButton:!0,confirmButtonText:"Emitir",denyButtonText:"Ver PDF",cancelButtonText:"Cancelar"});if(o.isConfirmed){const u=await Wa.issue(r.id);if(!(u!=null&&u.data))return;$(l.current).dxDataGrid("instance").refresh(),await yt(jt.referralGuide(u.data));return}if(!o.isDenied)return}await yt(jt.referralGuide(r));return}const i=await Wa.prepareFromCommercialOrder(e.id);i!=null&&i.data&&($(l.current).dxDataGrid("instance").refresh(),await yt(jt.referralGuide(i.data)))},en=async e=>{var i;if(!(e!=null&&e.id)||e.items&&(e.business||e.commercial_order||e.commercialOrder))return e;const r=await te.paginate({skip:0,take:1,isLoadingAll:!0,filter:["id","=",Number(e.id)]});return((i=r==null?void 0:r.data)==null?void 0:i[0])??e},Fa=async e=>{var f,j,_,S;const r=`${(e==null?void 0:e.local_status)??"pending"}`=="pending"?((f=await te.prepareVoucher(e.id))==null?void 0:f.data)??e:e,i=await en(r);if(!$t(i)){await z.fire({title:"Comprobante no preparado",text:"Primero genera serie y correlativo del comprobante.",icon:"warning",confirmButtonText:"Entendido"});return}const o=window.open("","_blank");if(!o){await z.fire({title:"Impresion bloqueada",text:"El navegador bloqueo la ventana de impresion.",icon:"warning",confirmButtonText:"Entendido"});return}const u=x=>{var b,P,I;return((I=(b=x==null?void 0:x.toString)==null?void 0:(P=b.call(x)).slice)==null?void 0:I.call(P,0,10))??""},d=(i==null?void 0:i.items)??[],v=d.length?d.map(x=>`
        <tr>
          <td>${T(x.description)}</td>
          <td class="right">${Number(x.quantity??0).toFixed(2)}</td>
          <td class="right">${Number(x.unit_price??0).toFixed(2)}</td>
          <td class="right">${Number(x.total??0).toFixed(2)}</td>
        </tr>
      `).join(""):'<tr><td colspan="4" class="muted">Sin detalle de items</td></tr>';o.document.write(`<!doctype html>
      <html>
        <head>
        ...
        <body>
          ...
          <div class="header">
            <div>
              ...
              <div class="muted">${T(((_=i==null?void 0:i.branch)==null?void 0:_.address)??"")}</div>
              <div class="muted">${T(((S=i==null?void 0:i.business)==null?void 0:S.tax_number)??"")}</div>
            </div>
            <div class="number">
          ...
          <div class="grid">
            ...
            <div><div class="label">Fecha</div>${T(u(i.issue_date))}</div>
            <div><div class="label">Cliente</div>${T(Vn(i))}</div>
            <div><div class="label">Moneda</div>${T(wt(i.currency))}</div>
            <div><div class="label">Pedido comercial</div>${T(Un(i))}</div>
