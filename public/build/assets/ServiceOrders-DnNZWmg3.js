var is=Object.defineProperty;var ns=(i,c,u)=>c in i?is(i,c,{enumerable:!0,configurable:!0,writable:!0,value:u}):i[c]=u;var w=(i,c,u)=>ns(i,typeof c!="symbol"?c+"":c,u);import{m as as,t as os,C as ls,c as cs,j as e,r as d,S as F}from"./CreateReactScript-DzmYTmbr.js";import{B as ds}from"./Base-BFIC9n1T.js";import{T as us,t as Le,E as ms,q as ps}from"./Table-CO65K1hT.js";import{M as Ae}from"./Modal-DGAB1eIb.js";import{D as Me}from"./DxButton-CsjWvhyj.js";import{B as gs}from"./BasicRest-DlKnEI0V.js";import{a as H}from"./permissionScope-etO_1UXy.js";import{r as vt}from"./renderGridEditLink-D8NGEeKJ.js";import{o as hs,b as xs}from"./magistralesRecordPdf-u2rK0s4i.js";const oe=async(i,c={})=>{try{const{status:u,result:g}=await as.Fetch(i,{method:"POST",body:JSON.stringify({take:1e3,skip:0,isLoadingAll:!0,...c})});if(!u)throw new Error((g==null?void 0:g.message)||"No se pudo cargar la lista");return(g==null?void 0:g.data)??[]}catch(u){return os.error("Error",{description:u.message,duration:3e3,richColors:!0}),[]}},fs=()=>location.pathname.includes("/admin/storage-general-service-orders"),bs=()=>location.pathname.includes("/admin/storage-service-orders");class vs extends gs{constructor(){super(...arguments);w(this,"path",H()?fs()?"admin/storage/general-service-orders":"admin/storage/service-orders":"admin/service-orders");w(this,"deleted",!1);w(this,"getBranchesByBusiness",async u=>u?await this.simpleGet(`/api/${this.path}/businesses/${u}/branches`)??[]:[]);w(this,"getBusinesses",async()=>await oe("/api/admin/businesses/paginate"));w(this,"getClients",async()=>await oe(H()?"/api/admin/storage/clients/paginate":"/api/admin/services-client/paginate"));w(this,"getServices",async()=>await oe(H()?"/api/admin/storage/general-service/paginate":"/api/admin/services/paginate",bs()?{storage_service_types:!0}:{}));w(this,"getStorageOptions",async()=>H()?await this.simpleGet("/api/admin/storage/kardex/options"):null);w(this,"getStorageWarehouses",async()=>H()?await oe("/api/admin/storage/kardex/paginate",{section:"warehouses",sort:[{selector:"warehouse_name",desc:!1}]}):[]);w(this,"getStorageLocations",async()=>H()?await oe("/api/admin/storage/kardex/paginate",{section:"locations"}):[])}async paginate(u){return await super.paginate({...u,deleted:this.deleted})}}const N=new vs,jt=i=>(i==null?void 0:i.fullname)||[i==null?void 0:i.name,i==null?void 0:i.lastname].filter(Boolean).join(" ")||(i==null?void 0:i.username)||"",le=()=>({uid:crypto.randomUUID(),service_id:"",scope:"",gloss:"",description:"",quantity:1,unit_price:0,detraction_percent:0,commission_percent:0,total:0}),_=(i="")=>i.toString().toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]/g,""),js=["Servicio de almacenamiento","Servicio de almacenamiento - Adicional"],ys=[{value:"PEN",label:"Soles"},{value:"USD",label:"Dolares"}],Nt=i=>(i==null?void 0:i.name)??(i==null?void 0:i.warehouse_name)??"",Ns=i=>(i==null?void 0:i.id)??(i==null?void 0:i.warehouse_id)??"",_s=i=>i==="approved"?"Aprobado":ps(i),Ss=i=>{const c=Ns(i),u=Nt(i);return{key:c?`warehouse-${c}`:_(u),warehouse_name:u,warehouse_id:c?`${c}`:"",enabled:!1,location_id:"",location_ids:[],location_label:"",location_labels:[],start_date:"",months:"",end_date:"",billing_dates:[],quantity_m3:"",tariff:"",monthly_amount:""}},$e=(i=[])=>i.filter(c=>(c==null?void 0:c.status)!==null).map(Ss),Ge=i=>{var c,u,g;return((g=(c=i==null?void 0:i.toString)==null?void 0:(u=c.call(i)).slice)==null?void 0:g.call(u,0,10))??""},ce=i=>Number(i||0),Ue=(i,c,u=!1)=>{if(!i)return"";const g=Number(c);if(!Number.isFinite(g)||g<0||!u&&g<=0)return"";const j=new Date(`${i}T00:00:00`);if(Number.isNaN(j.getTime()))return"";const b=new Date(j),I=b.getDate();return b.setDate(1),b.setMonth(b.getMonth()+g),b.setDate(Math.min(I,new Date(b.getFullYear(),b.getMonth()+1,0).getDate())),b.toISOString().slice(0,10)},yt=(i,c)=>{const u=Number.parseInt(c,10);return!i||!Number.isFinite(u)||u<=0?[]:Array.from({length:u},(g,j)=>({month:j+1,date:Ue(i,j,!0)}))},E=i=>i?[i.code,i.temperature_range].filter(Boolean).join(" | "):"",_t=(i="")=>i.split(",").map(c=>c.trim()).filter(Boolean),Be=i=>Array.isArray(i.location_ids)?i.location_ids.filter(Boolean).map(c=>`${c}`):i.location_id?[`${i.location_id}`]:[],Cs=(i,c)=>[i.warehouse_name,(Array.isArray(c)?c.map(E).filter(Boolean).join(", "):E(c))||i.location_label,`${i.start_date||""} - ${i.end_date||""}`,`${i.months||0} meses`,`${i.quantity_m3||0} m3`].filter(Boolean).join("; "),ws=(i="")=>{const c=i.split(";").map(g=>g.trim()),u=(c[2]??"").split("-").map(g=>g.trim());return{warehouse_name:c[0]??"",location_label:c[1]??"",location_labels:_t(c[1]??""),start_date:u.length>=3?`${u[0]}-${u[1]}-${u[2]}`.slice(0,10):"",end_date:u.length>=6?`${u[3]}-${u[4]}-${u[5]}`.slice(0,10):"",months:parseFloat(c[3])||"",quantity_m3:parseFloat(c[4])||""}},Fs=({moduleTitle:i="Ordenes de servicio",serviceOrderType:c="service"})=>{const u=d.useRef(),g=d.useRef(),j=d.useRef(),b=d.useRef(),I=d.useRef(),K=d.useRef(),J=d.useRef(),R=d.useRef(),S=d.useRef(),O=d.useRef(),de=d.useRef(),Y=d.useRef(),Q=d.useRef(),ue=d.useRef(),P=d.useRef(),z=d.useRef(),X=d.useRef(),L=d.useRef(),Ie=d.useRef(null),Z=d.useRef(),me=d.useRef(),ee=d.useRef(),We=d.useRef(),[pe,St]=d.useState([]),[Rs,Ct]=d.useState([]),[ge,wt]=d.useState([]),[he,Ft]=d.useState([]),[A,xe]=d.useState(""),[M,te]=d.useState(""),[se,fe]=d.useState(""),[Ve,He]=d.useState(""),[Rt,Ke]=d.useState("PEN"),[be,De]=d.useState(!1),[ve,Je]=d.useState("services"),[je,Ye]=d.useState(""),[ye,Qe]=d.useState(""),[Ne,Xe]=d.useState(""),[Ze,et]=d.useState(null),[_e,$t]=d.useState({penTotal:0,penBilled:0,usdTotal:0,usdBilled:0}),[re,T]=d.useState([le()]),[G,Bt]=d.useState([]),[U,It]=d.useState([]),[tt,Se]=d.useState(()=>$e()),[st,Dt]=d.useState(!1),[Tt,rt]=d.useState(""),[kt,qt]=d.useState(!1),ie=c==="storage_general",C=c==="storage_service",D=ie||C,y=!D,Et=he.filter(t=>js.some(s=>_(s)===_(t.name))),Te=Object.fromEntries(he.map(t=>[`${t.id}`,t])),it=async()=>{if(!C)return{warehouseRows:[],locationRows:[]};Ie.current||(Ie.current=(async()=>{const r=await N.getStorageOptions();let a=((r==null?void 0:r.warehouses)??[]).filter(l=>l.status!==null),o=((r==null?void 0:r.locations)??[]).filter(l=>l.status!==null);if(!a.length||!o.length){const[l,m]=await Promise.all([o.length?Promise.resolve(o):N.getStorageLocations(),a.length?Promise.resolve(a):N.getStorageWarehouses()]);a=(a.length?a:m??[]).filter(n=>n.status!==null),o=(o.length?o:l??[]).filter(n=>n.status!==null)}return{warehouseRows:a,locationRows:o}})());const{warehouseRows:t,locationRows:s}=await Ie.current;return Bt(t),It(s),Dt(!0),{warehouseRows:t,locationRows:s}};d.useEffect(()=>{(async()=>{var n;const s=C?it():Promise.resolve({warehouseRows:[],locationRows:[]}),[r,a,o,l]=await Promise.all([N.getBusinesses(),N.getClients(),N.getServices(),s]),m=r??[];if(St(m),wt((a??[]).filter(p=>p.status!==null)),Ft((o??[]).filter(p=>p.status!==null)),C&&Se($e(l.warehouseRows)),C||y){const p=m[0];if(p){xe(`${p.id}`);const v=await Ce(p.id);(n=v[0])!=null&&n.id&&te(`${v[0].id}`)}}})()},[]),d.useEffect(()=>{if(!y)return;N.deleted=ve==="deleted";const t=u.current?$(u.current).dxDataGrid("instance"):null;t&&t.refresh()},[ve]);const Ot=()=>{const t=[];je&&t.push(["client_id","=",Number(je)]),ye&&t.push(["created_at",">=",`${ye} 00:00:00`]),Ne&&t.push(["created_at","<=",`${Ne} 23:59:59`]),et(t.length?t.reduce((s,r)=>s.length?[...s,"and",r]:r,[]):null)},Pt=()=>{Ye(""),Qe(""),Xe(""),et(null)},zt=t=>{const r=((t==null?void 0:t.data)??[]).reduce((a,o)=>{const l=`${o.currency??"PEN"}`.toUpperCase(),m=Number(o.total||0),n=o.billing_status==="billed"||o.order_status==="invoiced"?m:Number(o.paid_amount||0);return l==="USD"?(a.usdTotal+=m,a.usdBilled+=n):(a.penTotal+=m,a.penBilled+=n),a},{penTotal:0,penBilled:0,usdTotal:0,usdBilled:0});$t(r)},Ce=async(t,s="")=>{const a=await N.getBranchesByBusiness(t)??[];return Ct(a),te(s?`${s}`:""),a},nt=t=>({...t,total:Number(t.quantity||0)*Number(t.unit_price||0)}),k=(t,s="")=>{var r;return((r=t.current)==null?void 0:r.value)||s||""},at=(t="")=>{const s=`${t??""}`.trim(),r=s.match(/^client-(\d+)$/i);return r?r[1]:s},ot=(t,s=G)=>s.find(r=>_(Nt(r))===_(t)),lt=(t,s=G)=>{var r;return t.warehouse_id||((r=ot(t.warehouse_name,s))==null?void 0:r.id)||""},ct=(t,s=U,r=G)=>{const a=lt(t,r);return s.filter(o=>a&&`${o.warehouse_id}`==`${a}`?!0:_(o.warehouse_name)===_(t.warehouse_name))},dt=(t,s=U,r=G)=>{const a=ct(t,s,r),o=Be(t),l=o.length?a.filter(n=>o.includes(`${n.id}`)):[];return l.length?l:(Array.isArray(t.location_labels)&&t.location_labels.length?t.location_labels:_t(t.location_label)).map(n=>a.find(p=>_(E(p))===_(n))).filter(Boolean)},Lt=(t=[],s=G,r=U)=>{const a=$e(s);return t.forEach(o=>{var v,h;const l=ws(o.description??""),m=a.findIndex(B=>_(B.warehouse_name)===_(l.warehouse_name));if(m<0)return;const n={...a[m],enabled:!0,warehouse_id:((v=ot(a[m].warehouse_name,s))==null?void 0:v.id)??a[m].warehouse_id,location_label:l.location_label,location_labels:l.location_labels,start_date:l.start_date,months:l.months||"",end_date:l.end_date||Ue(l.start_date,l.months),billing_dates:yt(l.start_date,l.months),quantity_m3:l.quantity_m3||Number(o.quantity||0)||"",tariff:Number(o.unit_price||0)||"",monthly_amount:Number(o.total||0)||""},p=dt(n,r,s);a[m]={...n,location_id:(h=p[0])!=null&&h.id?`${p[0].id}`:"",location_ids:p.map(B=>`${B.id}`)}}),a},W=(t,s)=>{Se(r=>r.map(a=>{if(a.key!==t)return a;const o="location_ids"in s?(Array.isArray(s.location_ids)?s.location_ids:[s.location_ids]).filter(Boolean).map(p=>`${p}`):null,l=s.location_id?U.find(p=>`${p.id}`==`${s.location_id}`):null,m=o?U.filter(p=>o.includes(`${p.id}`)):null,n={...a,...s,warehouse_id:lt(a)};if(l&&(n.location_label=E(l)),m&&(n.location_ids=o,n.location_id=o[0]??"",n.location_labels=m.map(E).filter(Boolean),n.location_label=n.location_labels.join(", ")),("start_date"in s||"months"in s)&&(n.end_date=Ue(n.start_date,n.months),n.billing_dates=yt(n.start_date,n.months)),"quantity_m3"in s||"tariff"in s){const p=ce(n.quantity_m3)*ce(n.tariff);n.monthly_amount=p?p.toFixed(2):""}return n}))},At=(t,s,r)=>{Se(a=>a.map(o=>o.key!==t?o:{...o,billing_dates:(o.billing_dates??[]).map((l,m)=>m===s?{...l,date:r}:l)}))},Mt=(t,s)=>{const r=`${s}`,a=Be(t),o=a.includes(r)?a.filter(l=>l!==r):[...a,r];W(t.key,{location_ids:o})},ne=async(t=null)=>{var n,p,v;qt(!!(t!=null&&t.id)),j.current.value=(t==null?void 0:t.id)??"",b.current.value=(t==null?void 0:t.code)??"Se genera al guardar",I.current.value=Ge(t==null?void 0:t.issue_date)||new Date().toISOString().slice(0,10),K.current.value=Ge(t==null?void 0:t.scheduled_at),J.current.value=Ge(t==null?void 0:t.first_due_date),R.current.value=(t==null?void 0:t.expected_document_type)??(D?"":"Factura");const s=(t==null?void 0:t.currency)??(D?"":"PEN");S.current.value=s,Ke(s||"PEN"),O.current.value=(t==null?void 0:t.billing_cycle)??(y?"Unico":""),de.current&&(de.current.value=(t==null?void 0:t.contract_label)??""),Y.current.value=(t==null?void 0:t.payment_condition)??"Contado",Q.current.value=Number((t==null?void 0:t.installments)??1),ue.current&&(ue.current.value=(t==null?void 0:t.billing_day)??""),P.current.value=(t==null?void 0:t.order_status)??(ie?"approved":"draft"),z.current.value=(t==null?void 0:t.billing_status)??"pending",X.current.value=Number((t==null?void 0:t.tax_amount)??0),L.current.value=(t==null?void 0:t.observations)??"",De(!!((t==null?void 0:t.detraction_enabled)??((t==null?void 0:t.items)??[]).some(h=>Number(h.detraction_percent||0)>0)));const r=t!=null&&t.business_id?`${t.business_id}`:A||((n=pe[0])!=null&&n.id?`${pe[0].id}`:"");xe(r),fe(t!=null&&t.client_id?`${t.client_id}`:"");const a=await Ce(r,(t==null?void 0:t.business_branch_id)??M);!(t!=null&&t.business_branch_id)&&!M&&((p=a[0])!=null&&p.id)&&te(`${a[0].id}`);const o=((t==null?void 0:t.items)??[]).map(h=>{var B,ae;return{uid:crypto.randomUUID(),service_id:`${h.service_id}`,scope:h.scope??((B=h.service)==null?void 0:B.category)??"",gloss:h.gloss??h.description??((ae=h.service)==null?void 0:ae.name)??"",description:h.description??"",quantity:Number(h.quantity||0),unit_price:Number(h.unit_price||0),detraction_percent:Number(h.detraction_percent||0),commission_percent:Number(h.commission_percent||0),total:Number(h.total||0)}});He(((v=o[0])==null?void 0:v.service_id)??"");let l=G,m=U;if(C&&(!l.length||!m.length||!st)){const h=await it();l=h.warehouseRows,m=h.locationRows}Se(C?Lt((t==null?void 0:t.items)??[],l,m):$e()),T(o.length?o:ie?[]:[le()]),$(g.current).modal("show")},q=(t,s,r)=>{T(a=>a.map(o=>{var m;if(o.uid!==t)return o;const l={...o,[s]:r};if(s==="service_id"){const n=Te[r];l.scope=l.scope||(n==null?void 0:n.category)||"",l.gloss=l.gloss||(n==null?void 0:n.name)||"",l.description=l.gloss||l.description||(n==null?void 0:n.name)||"",l.unit_price=Number(((m=S.current)==null?void 0:m.value)==="USD"?n==null?void 0:n.unit_price_usd:n==null?void 0:n.unit_price_pen)||0}return s==="gloss"&&(l.description=r),nt(l)}))},ut=t=>{Ke(t||"PEN"),T(s=>s.map(r=>{if(!r.service_id)return r;const a=Te[r.service_id];return nt({...r,unit_price:Number(t==="USD"?a==null?void 0:a.unit_price_usd:a==null?void 0:a.unit_price_pen)||0})}))},ke=async t=>{var v,h,B,ae;if(t.preventDefault(),C){const f=k(Z,A),Fe=k(me,M),gt=at(k(ee,se)),Oe=k(We,Ve),V=tt.filter(x=>x.enabled),ht=V.find(x=>!Be(x).length||!x.start_date||!x.months||!x.end_date||!x.quantity_m3||!x.tariff);if(!f||!Fe||!gt||!R.current.value||!S.current.value||!Oe){F.fire("Formulario incompleto","Completa empresa, cliente, tipo documento, moneda y tipo de servicio.","warning");return}if(!V.length){F.fire("Formulario incompleto","Selecciona al menos un almacen.","warning");return}if(ht){F.fire("Formulario incompleto",`Completa los datos de ${ht.warehouse_name}.`,"warning");return}const xt=V.find(x=>{const ze=Number.parseInt(x.months,10);return!Array.isArray(x.billing_dates)||x.billing_dates.length!==ze||x.billing_dates.some(Re=>!Re.date)});if(xt){F.fire("Formulario incompleto",`Completa las fechas de facturacion de ${xt.warehouse_name}.`,"warning");return}const ft=V.map(x=>x.start_date).filter(Boolean).sort(),es=Math.max(...V.map(x=>Number(x.months||1))),Pe=Te[Oe],ts={id:j.current.value||void 0,business_id:f||null,business_branch_id:Fe||null,client_id:gt||null,expected_document_type:R.current.value,currency:S.current.value,billing_cycle:(Pe==null?void 0:Pe.name)??"",payment_condition:"Contado",installments:es||1,issue_date:I.current.value||new Date().toISOString().slice(0,10),scheduled_at:ft[0]??null,first_due_date:ft[0]??null,order_status:P.current.value||"draft",billing_status:z.current.value||"pending",tax_amount:0,observations:L.current.value.trim(),items:V.map(x=>{const ze=dt(x),Re=ce(x.quantity_m3),bt=ce(x.tariff),ss=ce(x.monthly_amount)||Re*bt;return{service_id:Oe,description:Cs(x,ze),quantity:Re,unit_price:bt,detraction_percent:0,commission_percent:0,total:ss,billing_dates:(x.billing_dates??[]).map(rs=>rs.date)}})};if(!await N.save(ts))return;$(u.current).dxDataGrid("instance").refresh(),$(g.current).modal("hide");return}const s=k(Z,A),r=k(me,M),a=at(k(ee,se)),o=re.filter(f=>f.service_id).map(f=>({service_id:f.service_id,scope:f.scope,gloss:f.gloss,description:f.gloss||f.description,quantity:f.quantity,unit_price:f.unit_price,detraction_percent:y&&be?f.detraction_percent||12:f.detraction_percent,commission_percent:f.commission_percent,total:f.total}));if(ie){if(!s||!r||!a||!R.current.value||!S.current.value){F.fire("Formulario incompleto","Completa empresa, cliente, tipo documento y moneda.","warning");return}if(!o.length){F.fire("Formulario incompleto","Agrega al menos un servicio general.","warning");return}}else if(y){if(!s||!r||!a||!R.current.value||!S.current.value||!O.current.value){F.fire("Formulario incompleto","Completa cliente, comprobante, moneda y ciclo de facturacion.","warning");return}if(!o.length){F.fire("Formulario incompleto","Agrega al menos un item de servicio.","warning");return}}const l=o.reduce((f,Fe)=>f+Number(Fe.total||0),0),m=Number(y?(l*.18).toFixed(2):X.current.value||0),n={id:j.current.value||void 0,business_id:s||null,business_branch_id:r||null,client_id:a||null,contract_label:((B=(h=(v=de.current)==null?void 0:v.value)==null?void 0:h.trim)==null?void 0:B.call(h))||null,expected_document_type:R.current.value,currency:S.current.value,billing_cycle:O.current.value.trim(),payment_condition:Y.current.value,installments:Q.current.value,billing_day:((ae=ue.current)==null?void 0:ae.value)||null,detraction_enabled:y?be:!1,issue_date:I.current.value,scheduled_at:K.current.value||null,first_due_date:J.current.value||null,order_status:P.current.value,billing_status:z.current.value,tax_amount:m,observations:L.current.value.trim(),items:o};await N.save(n)&&($(u.current).dxDataGrid("instance").refresh(),$(g.current).modal("hide"))},Gt=async t=>{const{isConfirmed:s}=await F.fire({title:"Anular orden de servicio",text:"Se dara de baja la orden de servicio.",icon:"warning",showCancelButton:!0,confirmButtonText:"Si, anular",cancelButtonText:"Cancelar"});!s||!await N.delete(t)||$(u.current).dxDataGrid("instance").refresh()},Ut=(t,{data:s})=>{const r=(s==null?void 0:s.order_status)??"",a=document.createElement("span");a.className=`badge ${r==="approved"?"bg-soft-success text-success":r==="cancelled"?"bg-soft-danger text-danger":"bg-soft-warning text-warning"}`,a.textContent=_s(r),t.append(a)},Wt=(t,{data:s})=>{const r=(s==null?void 0:s.billing_status)==="billed"||(s==null?void 0:s.order_status)==="invoiced",a=document.createElement("span");a.className=`badge ${r?"bg-soft-success text-success":"bg-soft-warning text-warning"}`,a.textContent=r?"Facturado":"Pendiente",t.append(a)},Vt=t=>(t.items??[]).map(s=>{var r;return s.gloss||s.description||((r=s.service)==null?void 0:r.name)}).filter(Boolean).join(" | "),Ht=t=>(t==null?void 0:t.billing_status)==="billed"||(t==null?void 0:t.order_status)==="invoiced"?Number((t==null?void 0:t.total)||0):0,mt={caption:"Acciones",width:D?92:150,allowFiltering:!1,allowExporting:!1,cellTemplate:(t,{data:s})=>{t.css("text-overflow","unset"),t.append(Me({className:D?"btn btn-xs btn-soft-warning":"btn btn-xs btn-soft-primary",title:"Editar orden de servicio",icon:"mdi mdi-pencil",onClick:()=>ne(s)})),D||t.append(Me({className:"btn btn-xs btn-soft-danger ms-1",title:"Imprimir PDF",icon:"mdi mdi-file-pdf-box",onClick:()=>hs(xs.serviceOrder(s))})),t.append(Me({className:"btn btn-xs btn-soft-danger ms-1",title:"Anular orden de servicio",icon:D?"mdi mdi-close":"mdi mdi-delete",onClick:()=>Gt(s.id)}))}},Kt=[{dataField:"row_number",caption:"#",width:56,allowFiltering:!1,calculateCellValue:t=>t.id},mt,{dataField:"billing_status",caption:"Estado",width:130,lookup:Le([{value:"pending",label:"Pendiente"},{value:"billed",label:"Facturado"}]),cellTemplate:Wt},{dataField:"code",caption:"Orden Servicio",width:150,cellTemplate:(t,{data:s})=>vt(t,s==null?void 0:s.code,()=>ne(s),"Editar orden de servicio")},{dataField:"billing_cycle",caption:"Ciclo Facturación",width:155},{dataField:"client.document_number",caption:"Doc. Cliente",width:140},{dataField:"client.full_name",caption:"Cliente",minWidth:200},{dataField:"services_text",caption:"Servicios",minWidth:260,calculateCellValue:Vt},{dataField:"total_prefactures",caption:"Total Prefacturas",width:150,dataType:"number",format:{type:"fixedPoint",precision:2},calculateCellValue:t=>Number(t.total||0)},{dataField:"total",caption:"Total Servicio",width:145,dataType:"number",format:{type:"fixedPoint",precision:2}},{dataField:"total_billed",caption:"Total Facturado",width:150,dataType:"number",format:{type:"fixedPoint",precision:2},calculateCellValue:Ht},{dataField:"contract_label",caption:"Contrato",width:150},{dataField:"creator.fullname",caption:"Usuario Registro",minWidth:150,calculateCellValue:t=>jt(t.creator)},{dataField:"created_at",caption:"Fecha Registro",dataType:"datetime",width:170,format:"yyyy-MM-dd HH:mm:ss"}],Jt=[mt,{dataField:"order_status",caption:"Estado",width:115,lookup:Le(ms),cellTemplate:Ut},{dataField:"code",caption:"Codigo",width:125,cellTemplate:(t,{data:s})=>vt(t,s==null?void 0:s.code,()=>ne(s),"Editar orden de servicio")},{dataField:"business.name",caption:"Empresa",minWidth:170},{dataField:"client.full_name",caption:"Cliente",minWidth:220},{dataField:"expected_document_type",caption:"Tipo comprobante",width:160},{dataField:"currency",caption:"Moneda",width:105,lookup:Le(ys)},{dataField:"created_at",caption:"Fecha registro",dataType:"datetime",width:170,format:"yyyy-MM-dd HH:mm:ss"},{dataField:"creator.fullname",caption:"Usuario registro",minWidth:160,calculateCellValue:t=>jt(t.creator)}],Yt=D?Jt:Kt,Qt=re.reduce((t,s)=>t+Number(s.total||0),0),qe=re.reduce((t,s)=>t+Number(s.total||0),0),pt=Number((qe*.18).toFixed(2)),Xt=Number((qe+pt).toFixed(2)),Ee=Rt==="USD"?"$":"S/",we=t=>Number(t||0).toFixed(5),Zt=y?e.jsxs("div",{className:"service-order-list-panel",children:[e.jsxs("div",{className:"service-order-tabs",children:[e.jsx("button",{type:"button",className:ve==="services"?"active":"",onClick:()=>Je("services"),children:"Servicios"}),e.jsx("button",{type:"button",className:ve==="deleted"?"active":"",onClick:()=>Je("deleted"),children:"OS Eliminadas"})]}),e.jsxs("div",{className:"service-order-filter-panel",children:[e.jsxs("div",{className:"row g-3 align-items-end",children:[e.jsxs("div",{className:"col-12 col-lg-6",children:[e.jsx("label",{className:"form-label",children:"Cliente"}),e.jsxs("select",{className:"form-select",value:je,onChange:t=>Ye(t.target.value),children:[e.jsx("option",{value:"",children:"Todos"}),ge.map(t=>e.jsxs("option",{value:t.entity_id??t.id,children:[t.document_number?`${t.document_number} - `:"",t.full_name]},`service-order-filter-client-${t.id}`))]})]}),e.jsxs("div",{className:"col-12 col-lg-6",children:[e.jsx("label",{className:"form-label",children:"Fecha Registro (Inicio - Fin):"}),e.jsxs("div",{className:"service-order-date-range",children:[e.jsx("input",{type:"date",className:"form-control",value:ye,onChange:t=>Qe(t.target.value)}),e.jsx("input",{type:"date",className:"form-control",value:Ne,onChange:t=>Xe(t.target.value)})]})]})]}),e.jsxs("div",{className:"service-order-filter-actions",children:[e.jsxs("button",{type:"button",className:"btn service-order-outline-btn",onClick:Ot,children:[e.jsx("i",{className:"mdi mdi-filter me-1"})," Filtrar"]}),(je||ye||Ne||Ze)&&e.jsx("button",{type:"button",className:"btn service-order-muted-btn",onClick:Pt,children:"Limpiar"})]})]}),e.jsxs("div",{className:"service-order-summary",children:[e.jsxs("div",{children:[e.jsx("span",{children:"Importe Total"}),e.jsxs("strong",{className:"text-success",children:["S/ ",we(_e.penTotal)]}),e.jsxs("strong",{className:"text-success",children:["$ ",we(_e.usdTotal)]})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Total Facturado"}),e.jsxs("strong",{className:"text-warning",children:["S/ ",we(_e.penBilled)]}),e.jsxs("strong",{className:"text-warning",children:["$ ",we(_e.usdBilled)]})]})]})]}):i;return e.jsxs(e.Fragment,{children:[y&&e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        ...
        `}),e.jsx("input",{ref:j,hidden:!0}),e.jsx("input",{ref:b,hidden:!0}),e.jsx("input",{ref:I,type:"date",hidden:!0}),e.jsx("input",{ref:K,type:"date",hidden:!0}),e.jsx("input",{ref:J,type:"date",hidden:!0}),e.jsx("input",{ref:O,hidden:!0}),e.jsx("input",{ref:Y,hidden:!0}),e.jsx("input",{ref:Q,type:"number",hidden:!0}),e.jsx("input",{ref:P,hidden:!0}),e.jsx("input",{ref:z,hidden:!0}),e.jsx("input",{ref:X,type:"number",hidden:!0}),e.jsx("textarea",{ref:L,hidden:!0}),e.jsx("input",{ref:me,type:"hidden",value:M,readOnly:!0}),e.jsxs("div",{className:"storage-general-order-actions",children:[e.jsxs("button",{type:"submit",className:"btn btn-primary-outline",children:[e.jsx("i",{className:"mdi mdi-plus me-1"})," Guardar"]}),e.jsxs("button",{type:"button",className:"btn btn-muted","data-bs-dismiss":"modal",children:[e.jsx("i",{className:"mdi mdi-close me-1"})," Cerrar"]})]}),e.jsx("h3",{className:"storage-general-order-heading",children:"Orden de servicio N°"}),e.jsxs("div",{className:"row g-4 align-items-end",children:[e.jsxs("div",{className:"col-12 col-md-6 col-xl-2",children:[e.jsx("label",{className:"form-label",children:"Empresa"}),e.jsxs("select",{ref:Z,className:"form-select",value:A,onChange:async t=>{var r;xe(t.target.value);const s=await Ce(t.target.value);te((r=s[0])!=null&&r.id?`${s[0].id}`:"")},required:!0,children:[e.jsx("option",{value:"",children:"Seleccione"}),pe.map(t=>e.jsx("option",{value:t.id,children:t.name},`general-order-business-${t.id}`))]})]}),e.jsxs("div",{className:"col-12 col-md-6 col-xl-4",children:[e.jsx("label",{className:"form-label",children:"Cliente"}),e.jsxs("select",{ref:ee,className:"form-select",value:se,onChange:t=>fe(t.target.value),required:!0,children:[e.jsx("option",{value:"",children:"Seleccione"}),ge.map(t=>e.jsxs("option",{value:t.entity_id??t.id,children:[t.document_number?`${t.document_number} | `:"",t.full_name]},`general-order-client-${t.id}`))]})]}),e.jsxs("div",{className:"col-12 col-md-6 col-xl-3",children:[e.jsx("label",{className:"form-label",children:"Tipo documento"}),e.jsxs("select",{ref:R,className:"form-select",required:!0,children:[e.jsx("option",{value:"",children:"Seleccione"}),e.jsx("option",{value:"Factura",children:"Factura"}),e.jsx("option",{value:"Boleta",children:"Boleta"}),e.jsx("option",{value:"Nota de pedido",children:"Nota de pedido"})]})]}),e.jsxs("div",{className:"col-12 col-md-6 col-xl-3",children:[e.jsx("label",{className:"form-label",children:"Moneda"}),e.jsxs("select",{ref:S,className:"form-select",onChange:t=>ut(t.target.value),required:!0,children:[e.jsx("option",{value:"",children:"Seleccione"}),e.jsx("option",{value:"PEN",children:"Soles"}),e.jsx("option",{value:"USD",children:"Dolares"})]})]})]}),e.jsx("div",{className:"mt-4 mb-3",children:e.jsxs("button",{type:"button",className:"btn btn-outline-primary storage-general-insert",onClick:()=>T(t=>[...t,le()]),children:[e.jsx("i",{className:"mdi mdi-plus-circle me-1"})," Insertar servicio general"]})}),e.jsx("div",{className:"table-responsive",children:e.jsxs("table",{className:"storage-general-lines",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Servicio"}),e.jsx("th",{style:{width:115},children:"Tarifa"}),e.jsx("th",{style:{width:115},children:"Cantidad"}),e.jsx("th",{style:{width:130},children:"Total"}),e.jsx("th",{style:{width:42}})]})}),e.jsx("tbody",{children:re.map(t=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsxs("select",{className:"form-select",value:t.service_id,onChange:s=>q(t.uid,"service_id",s.target.value),required:!0,children:[e.jsx("option",{value:"",children:"Seleccione servicio"}),he.map(s=>e.jsx("option",{value:s.id,children:s.name},`general-order-service-${s.id}`))]})}),e.jsx("td",{children:e.jsx("input",{type:"number",step:"0.01",className:"form-control",value:t.unit_price,onChange:s=>q(t.uid,"unit_price",s.target.value)})}),e.jsx("td",{children:e.jsx("input",{type:"number",step:"0.001",min:"0",className:"form-control",value:t.quantity,onChange:s=>q(t.uid,"quantity",s.target.value)})}),e.jsx("td",{children:e.jsx("input",{className:"form-control",value:Number(t.total||0).toFixed(2),disabled:!0})}),e.jsx("td",{children:e.jsx("button",{type:"button",className:"btn btn-outline-danger btn-sm",onClick:()=>T(s=>s.filter(r=>r.uid!==t.uid)),children:e.jsx("i",{className:"mdi mdi-close"})})})]},`general-order-item-${t.uid}`))}),e.jsx("tfoot",{children:e.jsxs("tr",{children:[e.jsx("td",{colSpan:"3",className:"storage-general-total-label",children:"Total"}),e.jsx("td",{children:e.jsx("input",{className:"form-control",value:Qt.toFixed(2),disabled:!0})}),e.jsx("td",{})]})})]})})]}):e.jsxs(Ae,{modalRef:g,title:kt?"Editar orden de servicio":"Registrar orden de servicio",size:"xl",bodyClass:"service-order-form-modal-body",btnCancelText:"Cerrar",btnSubmitText:"Guardar",onSubmit:ke,children:[e.jsx("style",{children:`
