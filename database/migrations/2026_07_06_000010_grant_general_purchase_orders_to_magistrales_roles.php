...
{
    /**
     * Al unificar la O. Compra de Magistrales con la O. Compra general de Almacen (el almacen
     * fijo 11 ahora se opera desde el modulo general), se concede el permiso general
     * 'purchase-orders' a todo rol que tuviera el permiso magistrales equivalente (especifico o
     * agrupador), para que ningun rol pierda acceso a las ordenes de compra del almacen de
     * Magistrales.
     */
