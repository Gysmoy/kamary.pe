...
{
    /**
     * Al unificar la Nota de Entrada de Magistrales con la Nota de Entrada general de Almacen
     * (el almacen fijo 11 ahora se opera desde el modulo general), se concede el permiso
     * general 'entry-note' a todo rol que tuviera el permiso magistrales equivalente
     * (especifico o agrupador), para que ningun rol pierda acceso a los ingresos del
     * almacen de Magistrales.
     */
