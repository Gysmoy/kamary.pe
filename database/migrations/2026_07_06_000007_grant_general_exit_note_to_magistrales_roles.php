...
{
    /**
     * Al unificar la Nota de Salida de Magistrales con la Nota de Salida general de Almacen
     * (el almacen fijo 11 ahora se opera desde el modulo general), se concede el permiso
     * general 'exit-note' a todo rol que tuviera el permiso magistrales equivalente
     * (especifico o agrupador), para que ningun rol pierda acceso a las salidas del
