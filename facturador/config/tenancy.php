...
/*
 * Legacy tenancy compatibility settings.
 * Runtime multi-tenant behavior is disabled in mono-company mode.
 */
...
return [
    'models' => [
        ...
        // Legacy hostname model
        'hostname' => \App\Models\System\Hostname::class,
//        'hostname' => \App\Models\System\Hostname::class,

        // Legacy website model
...
//        'website' => \App\Models\System\Website::class
     ...
     */
    // Single-company mode: disable tenancy runtime middleware.
    'middleware' => [],
    'website' => [
        /**
    ...
    'db' => [
         ...
         */
        'default' => env('TENANCY_DEFAULT_CONNECTION', env('DB_CONNECTION', 'mysql')),
        /**
         ...
         * @see src/Database/Connection.php
         */
        'tenant-division-mode' => env('TENANCY_DATABASE_DIVISION_MODE', 'bypass'),
