...
[API Setup Empresa (company/logo/certificate)](docs/api-company-setup.md)<br>
[API Auth (login/token/verify/logout)](docs/api-auth.md)<br>
[Modo Monoempresa (sin tenancy operativo)](docs/single-company-mode.md)<br>
[ER Simplificado (single company)](docs/ER_SINGLE_COMPANY.md)<br>
