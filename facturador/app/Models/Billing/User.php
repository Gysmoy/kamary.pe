 ...
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\Billing\Document[] $documents
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\Billing\Document[] $seller_documents
 * @property int|null $documents_count
 * @property \App\Models\Billing\Establishment $establishment
 * @property \Illuminate\Database\Eloquent\Collection|ModuleLevel[] $levels
 * @property int|null $levels_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\Billing\Module[] $modules
 * @property int|null $modules_count
 * @property \Illuminate\Notifications\DatabaseNotificationCollection|\Illuminate\Notifications\DatabaseNotification[] $notifications
 * @property int|null $notifications_count
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\Billing\SaleNote[] $sale_notes
 * @property \Illuminate\Database\Eloquent\Collection|\App\Models\Billing\SaleNote[] $seller_sale_notes
    ...
    */
    ...
    public function applyCustomerFilterBySeller()
    {
        ...
        if (!Schema::connection('tenant')->hasTable('configurations') ||
            !Schema::connection('tenant')->hasColumn('configurations', 'customer_filter_by_seller')) {
            return false;
        }

        try {
            $configuration = Configuration::select('customer_filter_by_seller')->first();
            return (bool) ($configuration->customer_filter_by_seller ?? false);
        } catch (Throwable $e) {
            return false;
        }
    }
