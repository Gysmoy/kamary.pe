    ...
    class ServiceController extends Controller
    {
        ...
        public function exchangeRateTest($date)
        {
            ...
            if ($date <= now()->format('Y-m-d')) {
                /**
                 * @var \App\Models\Billing\ExchangeRate $ex_rate
                 * @var \App\Models\Billing\ExchangeRate $last_ex_rate
                 */
                $ex_rate = \App\Models\Billing\ExchangeRate::where('date', $date)->first();
                if ($ex_rate) {
                    $sale = $ex_rate->sale;
                    ...
                    if ($res) {
                        $ex_rate = \App\Models\Billing\ExchangeRate::create([
                            'date' => $date,
                        ...
                        $last_ex_rate = \App\Models\Billing\ExchangeRate::orderBy('date', 'desc')->first();
                        if ($last_ex_rate) {
