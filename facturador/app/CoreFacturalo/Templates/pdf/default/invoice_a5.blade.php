@php
    ...
    $accounts_query = \App\Models\Tenant\BankAccount::query();
    if (\Illuminate\Support\Facades\Schema::connection('tenant')->hasColumn('bank_accounts', 'show_in_documents')) {
        $accounts_query->where('show_in_documents', true);
    }
